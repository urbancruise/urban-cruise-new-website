...
export default function PuneLuxuryBusPage() {
  ...
  const vehicleImages = [
    "/images/vehicles/luxury-bus-main.jpg",
    "/images/vehicles/luxury-bus-1.jpg",
    "/images/vehicles/luxury-bus-2.jpg",
    "/images/vehicles/luxury-bus-3.jpg",
  ];
  ...
  const reviews = [
    {
      name: "Dr. Meera Joshi",
      rating: 5,
      text: "The Luxury Bus was perfect for our heritage group tour in Pune. Comfortable and spacious!",
      date: "2 days ago"
    },
    {
      name: "Prof. Rajesh Kumar",
      rating: 5,
      text: "Excellent service! The Luxury Bus was clean and the driver was professional.",
      date: "4 days ago"
    },
    {
      name: "Mr. Ananya Patel",
      rating: 4,
      text: "Great value for money. Perfect for large group tours in Pune.",
      date: "1 week ago"
    },
  ];
    ...
    <div className="min-h-screen bg-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-[#00b894]/20 backdrop-blur-sm px-4 py-2 rounded-full mb-4 border border-[#00b894]/30">
                ...
                <span className="text-[#55efc4] font-medium text-sm">Pune - Luxury Bus</span>
              </div>
              ...
              <p className="text-lg text-gray-300 mb-6">
                Travel with large groups in luxury and comfort. Our Luxury Bus is perfect for 
            ...
            <div className="relative">
              <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-4 border border-white/10">
                <div className="relative h-[300px] md:h-[350px] rounded-xl overflow-hidden">
                  <Image src={vehicleImages[selectedImage]} alt="Luxury Bus" fill className="object-cover" />
                </div>
      ...
      <section className="py-8 bg-gradient-to-r from-[#00b894]/10 to-[#55efc4]/10">
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap justify-center gap-6 text-center">
            ...
            <div className="flex items-center gap-2 text-[#0a1a0a]">
              <FaUsers className="text-[#00b894] text-xl" />
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              <h2 className="text-2xl md:text-3xl font-bold text-[#0a1a0a] mb-6">Vehicle Features</h2>
              <p className="text-gray-600 mb-8">Our Luxury Bus comes with premium features for a comfortable group journey.</p>
              <div className="grid grid-cols-2 gap-4">
                {features.map((feature, index) => (
                  <div key={index} className="bg-white p-4 rounded-xl shadow-sm">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-full bg-[#00b894]/10 flex items-center justify-center text-[#00b894]"><feature.icon /></div>
                      <div><p className="text-xs text-gray-500">{feature.label}</p><p className="font-semibold text-[#0a1a0a]">{feature.value}</p></div>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div>
              <h2 className="text-2xl md:text-3xl font-bold text-[#0a1a0a] mb-6">Specifications</h2>
              <p className="text-gray-600 mb-8">Technical specifications of our Luxury Bus.</p>
      ...
      <section id="packages" className="py-16 md:py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-[#0a1a0a] mb-4">Rental Packages</h2>
            <p className="text-gray-600 text-lg">Choose from our flexible rental packages for the Luxury Bus.</p>
          </div>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600 text-lg">What our customers say about the Luxury Bus in Pune.</p>
          </div>
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-[#00b894] to-[#55efc4]">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-white/90 text-lg max-w-2xl mx-auto mb-8">Book your Luxury Bus today and explore Pune with your group.</p>
