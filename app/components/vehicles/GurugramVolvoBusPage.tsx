...
export default function GurugramVolvoBusPage() {
  ...
  const reviews = [
    {
      ...
      rating: 5,
      text: "The Volvo Bus is the epitome of luxury group travel in Gurugram. Highly recommended!",
      date: "1 day ago"
    },
    {
      name: "Ms. Neha Gupta",
    ...
    },
    {
      ...
      rating: 5,
      text: "The best luxury bus service in Gurugram. Perfect for corporate group tours.",
      date: "5 days ago"
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-[#6c5ce7]/20 backdrop-blur-sm px-4 py-2 rounded-full mb-4 border border-[#6c5ce7]/30">
                ...
                <span className="text-[#a29bfe] font-medium text-sm">Gurugram - Volvo Bus</span>
              </div>
              ...
              <p className="text-lg text-gray-300 mb-6">
                ...
                corporate events, business tours, and special occasions in Gurugram.
              </p>
              <div className="flex flex-wrap gap-4">
                <Link href={getLocationUrl("/book")} className="inline-flex items-center gap-2 px-8 py-3 bg-[#6c5ce7] hover:bg-[#5a4bd1] text-white font-semibold rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-[#6c5ce7]/30">
      ...
      {/* Features & Specs - Same pattern as Luxury Bus */}
                ...
                <ul className="space-y-2 mb-6">
                  {pkg.features.map((feature, i) => (
                    <li key={i} className="flex items-center gap-2 text-sm text-gray-600">
                      <FaCheck className="text-[#6c5ce7] text-xs" /> {feature}
                    </li>
                  ))}
                </ul>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600 text-lg">What our customers say about the Volvo Bus in Gurugram.</p>
          </div>
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-[#6c5ce7] to-[#8b7cf7]">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-white/90 text-lg max-w-2xl mx-auto mb-8">Book your Volvo Bus today and experience luxury group travel in Gurugram.</p>
