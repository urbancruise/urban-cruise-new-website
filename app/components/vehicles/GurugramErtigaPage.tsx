...
import { 
  ...
  FaPhone, FaEnvelope, FaCalendarCheck, FaChild,
  FaLuggageCart, FaRoad
} from "react-icons/fa";
...
export default function GurugramErtigaPage() {
  ...
  const vehicleImages = [
    "/images/vehicles/ertiga-main.jpg",
    "/images/vehicles/ertiga-1.jpg",
    "/images/vehicles/ertiga-2.jpg",
    "/images/vehicles/ertiga-3.jpg",
  ];
  ...
  const features = [
    ...
    { icon: FaChild, label: "Child Seat", value: "Available" },
    { icon: FaLuggageCart, label: "Boot Space", value: "300 L" },
  ];

  const specs = [
    { label: "Model", value: "Maruti Suzuki Ertiga" },
    { label: "Engine", value: "1.5L K15C" },
  ...
  const reviews = [
    {
      name: "Vikram Singh",
      rating: 5,
      text: "Perfect family car for Gurugram trips. Comfortable and spacious.",
      date: "3 days ago"
    },
    {
      name: "Neha Gupta",
      rating: 5,
      text: "Excellent service! The Ertiga was clean and well-maintained.",
      date: "1 week ago"
    },
    {
      name: "Rajesh Kumar",
      rating: 4,
      text: "Great value for money. Perfect for family outings.",
      date: "2 weeks ago"
    },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-[#6c5ce7]/20 backdrop-blur-sm px-4 py-2 rounded-full mb-4 border border-[#6c5ce7]/30">
                ...
                <span className="text-[#a29bfe] font-medium text-sm">Gurugram - Ertiga</span>
              </div>
              ...
              <p className="text-lg text-gray-300 mb-6">
                Perfect family and corporate car for Gurugram. The Ertiga offers spacious 
                seating for 7 passengers with excellent fuel efficiency and comfort.
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-gray-600 mb-8">
                The Ertiga comes with family-friendly and corporate features for a comfortable journey.
              </p>
            ...
            <div>
              ...
              <p className="text-gray-600 mb-8">
                Technical specifications of the Maruti Suzuki Ertiga.
              </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600 text-lg">
              Choose from our flexible rental packages for the Ertiga.
            </p>
          </div>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600 text-lg">
              What our customers say about the Ertiga in Gurugram.
            </p>
          </div>
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-[#6c5ce7] to-[#8b7cf7]">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            Ready to Drive the Ertiga?
          </h2>
          <p className="text-white/90 text-lg max-w-2xl mx-auto mb-8">
            Book the perfect family car for your Gurugram trips today.
          </p>
          <Link
            href={getLocationUrl("/book")}
