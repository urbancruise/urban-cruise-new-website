...
import { 
  ...
  FaPhone, FaEnvelope, FaCalendarCheck, FaChair, FaRoad, FaTrophy, FaUmbrellaBeach
} from "react-icons/fa";
  ...
  const reviews = [
    {
      name: "Amit Sharma",
      rating: 5,
      text: "The Innova Crysta is the best MPV for Mumbai roads. Comfortable and powerful.",
      date: "2 days ago"
    },
    {
      name: "Priya Verma",
    ...
    },
    {
      name: "Suresh Patel",
      rating: 5,
      text: "Perfect for family trips and coastal drives. Highly recommend this vehicle.",
      date: "1 week ago"
    },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-[#ff6b6b]/20 backdrop-blur-sm px-4 py-2 rounded-full mb-4 border border-[#ff6b6b]/30">
                ...
                <span className="text-[#ff6b6b] font-medium text-sm">Mumbai - Innova Crysta</span>
              </div>
              ...
              <p className="text-lg text-gray-300 mb-6">
                ...
                space, and performance for your Mumbai journeys.
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-gray-600 mb-8">
                The Innova Crysta comes with premium features for a luxurious Mumbai experience.
              </p>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600 text-lg">
              What our customers say about the Innova Crysta in Mumbai.
            </p>
          </div>
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-[#ff6b6b] to-[#ff9a9a]">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-white/90 text-lg max-w-2xl mx-auto mb-8">
            Experience the king of MPVs in Mumbai. Book your Innova Crysta today.
          </p>
          <Link
            href={getLocationUrl("/book")}
