...
import { 
  ...
  FaChargingStation, FaUmbrella, FaFilm,
  FaUmbrellaBeach
} from "react-icons/fa";
  ...
  const reviews = [
    {
      ...
      rating: 5,
      text: "Perfect for our film crew in Mumbai. The Tempo Traveller was comfortable and spacious.",
      date: "1 day ago"
    },
    {
    ...
    },
    {
      name: "Mr. Amit Shah",
      rating: 4,
      text: "Great value for money. Perfect for group tours in Mumbai.",
      date: "1 week ago"
    },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-[#ff6b6b]/20 backdrop-blur-sm px-4 py-2 rounded-full mb-4 border border-[#ff6b6b]/30">
                ...
                <span className="text-[#ff6b6b] font-medium text-sm">Mumbai - Tempo Traveller</span>
              </div>
              ...
              <p className="text-lg text-gray-300 mb-6">
                ...
                for film shoots, group tours, and corporate events in Mumbai.
              </p>
      ...
      <section className="py-8 bg-gradient-to-r from-[#ff6b6b]/10 to-[#feca57]/10">
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap justify-center gap-6 text-center">
            ...
            <div className="flex items-center gap-2 text-[#0c0c1e]">
              <FaUsers className="text-[#ff6b6b] text-xl" />
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600 text-lg">
              What our customers say about the Tempo Traveller in Mumbai.
            </p>
          </div>
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-[#ff6b6b] to-[#ff9a9a]">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-white/90 text-lg max-w-2xl mx-auto mb-8">
            Book your Tempo Traveller today and explore Mumbai with your group.
          </p>
          <Link
            href={getLocationUrl("/book")}
