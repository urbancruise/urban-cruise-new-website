...
export default function GurugramHycrossPage() {
  ...
  const reviews = [
    ...
    },
    {
      name: "Sneha Reddy",
      rating: 5,
      text: "Luxury meets eco-friendly. The Hycross is perfect for Gurugram's corporate environment.",
      date: "3 days ago"
    },
    {
      name: "Vikram Singh",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-[#6c5ce7]/20 backdrop-blur-sm px-4 py-2 rounded-full mb-4 border border-[#6c5ce7]/30">
                ...
                <span className="text-[#a29bfe] font-medium text-sm">Gurugram - Hycross</span>
              </div>
              ...
              <p className="text-lg text-gray-300 mb-6">
                ...
                comfort with hybrid efficiency for an eco-friendly corporate experience.
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-gray-600 mb-8">
                The Hycross comes with premium features and hybrid technology for corporate travelers.
              </p>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600 text-lg">
              What our customers say about the Hycross in Gurugram.
            </p>
          </div>
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-[#6c5ce7] to-[#8b7cf7]">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-white/90 text-lg max-w-2xl mx-auto mb-8">
            Experience the future of luxury mobility in Gurugram. Book your Hycross today.
          </p>
          <Link
            href={getLocationUrl("/book")}
