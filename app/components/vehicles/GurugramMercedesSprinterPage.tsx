  ...
  const reviews = [
    {
      ...
      rating: 5,
      text: "The Mercedes Sprinter was perfect for our corporate event in Gurugram. Luxury and comfort redefined.",
      date: "2 days ago"
    },
    {
      name: "Ms. Neha Gupta",
    ...
    },
    {
      ...
      rating: 5,
      text: "The best luxury van service in Gurugram. Perfect for corporate group travel.",
      date: "1 week ago"
    },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-[#6c5ce7]/20 backdrop-blur-sm px-4 py-2 rounded-full mb-4 border border-[#6c5ce7]/30">
                ...
                <span className="text-[#a29bfe] font-medium text-sm">Gurugram - Mercedes Sprinter</span>
              </div>
              ...
              <p className="text-lg text-gray-300 mb-6">
                ...
                Perfect for corporate events, VIP transport, and business group tours in Gurugram.
              </p>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600 text-lg">
              What our customers say about the Mercedes Sprinter in Gurugram.
            </p>
          </div>
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-[#6c5ce7] to-[#8b7cf7]">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-white/90 text-lg max-w-2xl mx-auto mb-8">
            Book the Mercedes Sprinter today and experience luxury group travel in Gurugram.
          </p>
          <Link
            href={getLocationUrl("/book")}
