...
export default function GurugramSleeperBusPage() {
  ...
  const vehicleImages = [
    "/images/vehicles/sleeper-bus-main.jpg",
    "/images/vehicles/sleeper-bus-1.jpg",
    "/images/vehicles/sleeper-bus-2.jpg",
    "/images/vehicles/sleeper-bus-3.jpg",
  ];

  const features = [
    { icon: FaUsers, label: "Seats", value: "30-40" },
    { icon: FaBus, label: "Type", value: "Sleeper Bus" },
    { icon: FaBed, label: "Beds", value: "Sleeper/Semi Sleeper" },
    { icon: FaMoon, label: "Comfort", value: "Night Travel" },
  ...
  const specs = [
    { label: "Model", value: "Sleeper/Semi Sleeper Bus" },
  ...
  const packages = [
    {
      ...
      price: "₹11,000",
      km: "40 KM",
      features: ["Local travel", "Driver included", "Fuel included", "AC", "Sleeper"]
    },
    {
      name: "Full Day",
      duration: "8 Hours",
  ...
  const reviews = [
    {
      ...
      rating: 5,
      text: "The Sleeper Bus was perfect for our overnight corporate travel. So comfortable and spacious!",
      date: "1 day ago"
    },
    {
      name: "Ms. Neha Gupta",
      rating: 5,
      text: "Excellent service! The sleeper bus was clean and the beds were very comfortable.",
      date: "3 days ago"
    },
    {
      name: "Dr. Rajiv Malhotra",
      rating: 5,
      text: "The best sleeper bus service in Gurugram. Perfect for long-distance corporate group travel.",
      date: "5 days ago"
    },
  ];
    ...
    <div className="min-h-screen bg-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-[#6c5ce7]/20 backdrop-blur-sm px-4 py-2 rounded-full mb-4 border border-[#6c5ce7]/30">
                ...
                <span className="text-[#a29bfe] font-medium text-sm">Gurugram - Sleeper Bus</span>
              </div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight mb-4">
                Premium <span className="bg-gradient-to-r from-[#6c5ce7] to-[#a29bfe] bg-clip-text text-transparent">Sleeper Bus</span><br />in Gurugram
              </h1>
              <p className="text-lg text-gray-300 mb-6">Experience the ultimate comfort with our Sleeper | Semi Sleeper Bus. Perfect for overnight journeys, long-distance corporate travel, and group tours in Gurugram.</p>
            ...
            <div className="relative">
              <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-4 border border-white/10">
                <div className="relative h-[300px] md:h-[350px] rounded-xl overflow-hidden">
                  <Image src={vehicleImages[selectedImage]} alt="Sleeper Bus" fill className="object-cover" />
                </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-gray-600 mb-8">Our Sleeper Bus comes with premium features for a comfortable overnight journey.</p>
            ...
            <div>
              ...
              <p className="text-gray-600 mb-8">Technical specifications of our Sleeper Bus.</p>
      ...
      <section id="packages" className="py-16 md:py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600 text-lg">Choose from our flexible rental packages for the Sleeper Bus.</p>
          </div>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600 text-lg">What our customers say about the Sleeper Bus in Gurugram.</p>
          </div>
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-[#6c5ce7] to-[#8b7cf7]">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Ready for Comfortable Overnight Travel?</h2>
          <p className="text-white/90 text-lg max-w-2xl mx-auto mb-8">Book your Sleeper Bus today and experience comfort on your journey.</p>
