  ...
  const reviews = [
    {
      name: "Dr. Meera Joshi",
      rating: 5,
      text: "The Bharat Benz Bus is perfect for our heritage group tours in Pune. Comfortable and reliable!",
      date: "2 days ago"
    },
    {
    ...
    },
    {
      ...
      rating: 4,
      text: "Great value for money. Perfect for large group travel in Pune.",
      date: "1 week ago"
    },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-[#00b894]/20 backdrop-blur-sm px-4 py-2 rounded-full mb-4 border border-[#00b894]/30">
                ...
                <span className="text-[#55efc4] font-medium text-sm">Pune - Bharat Benz Bus</span>
              </div>
              ...
              <p className="text-lg text-gray-300 mb-6">
                ...
                Perfect for heritage tours, educational trips, and special occasions in Pune.
              </p>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600 text-lg">
              What our customers say about the Bharat Benz Bus in Pune.
            </p>
          </div>
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-[#00b894] to-[#55efc4]">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-white/90 text-lg max-w-2xl mx-auto mb-8">
            Book your Bharat Benz Bus today and explore Pune with your group.
          </p>
          <Link
            href={getLocationUrl("/book")}
