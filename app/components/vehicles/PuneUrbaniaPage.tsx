  ...
  const reviews = [
    {
      name: "Dr. Meera Joshi",
      rating: 5,
      text: "The Urbania is perfect for heritage group tours in Pune. Premium and comfortable!",
      date: "2 days ago"
    },
    {
    ...
    },
    {
      ...
      rating: 5,
      text: "The best premium mini bus service in Pune. Perfect for VIP groups and special occasions.",
      date: "1 week ago"
    },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-[#00b894]/20 backdrop-blur-sm px-4 py-2 rounded-full mb-4 border border-[#00b894]/30">
                ...
                <span className="text-[#55efc4] font-medium text-sm">Pune - Force Urbania</span>
              </div>
      ...
      <section className="py-8 bg-gradient-to-r from-[#00b894]/10 to-[#55efc4]/10">
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap justify-center gap-6 text-center">
            ...
            <div className="flex items-center gap-2 text-[#0a1a0a]">
              <FaCity className="text-[#00b894] text-xl" />
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600 text-lg">
              What our customers say about the Force Urbania in Pune.
            </p>
          </div>
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-[#00b894] to-[#55efc4]">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-white/90 text-lg max-w-2xl mx-auto mb-8">
            Book the Force Urbania today and experience premium group travel in Pune.
          </p>
          <Link
            href={getLocationUrl("/book")}
