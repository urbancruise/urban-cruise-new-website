...
import { 
  ...
  FaGem, FaWifi, FaMusic
} from "react-icons/fa";
import { IoMdArrowForward } from "react-icons/io";
import { useState } from "react";

export default function DelhiLuxuryCarsSuvsPage() {
  ...
  const specs = [
    { label: "Model", value: "Mercedes-Benz S-Class / BMW 7 Series" },
    { label: "Engine", value: "3.0L - 4.0L" },
    { label: "Transmission", value: "Automatic" },
    { label: "Mileage", value: "10-14 km/L" },
    { label: "Fuel Tank", value: "70-80 L" },
    { label: "Boot Space", value: "500-600 L" },
  ];
  ...
  const reviews = [
    {
      ...
      rating: 5,
      text: "The Mercedes S-Class was absolutely stunning! Perfect for our corporate event in Delhi.",
      date: "2 days ago"
    },
    {
      name: "Mrs. Priya Malhotra",
      rating: 5,
      text: "Luxury at its finest. The BMW 7 Series made our anniversary celebration unforgettable.",
      date: "5 days ago"
    },
    {
      name: "Mr. Vikram Singh",
      rating: 5,
      text: "The best luxury car rental service in Delhi. Professional chauffeurs and pristine vehicles.",
      date: "1 week ago"
    },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-[#e94560]/20 backdrop-blur-sm px-4 py-2 rounded-full mb-4 border border-[#e94560]/30">
                ...
                <span className="text-[#e94560] font-medium text-sm">Delhi - Luxury Cars & SUVs</span>
              </div>
              ...
              <p className="text-lg text-gray-300 mb-6">
                Experience the pinnacle of automotive luxury in Delhi. From Mercedes-Benz S-Class 
                to BMW 7 Series, our premium fleet redefines elegance and comfort.
              </p>
      ...
      <section className="py-8 bg-gradient-to-r from-[#e94560]/10 to-[#feca57]/10">
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap justify-center gap-6 text-center">
            ...
            <div className="flex items-center gap-2 text-[#1a1a2e]">
              <FaRoad className="text-[#e94560] text-xl" />
              <span>VIP Routes</span>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-gray-600 mb-8">
                Our luxury cars come with premium features for an unmatched experience in Delhi.
              </p>
            ...
            <div>
              ...
              <p className="text-gray-600 mb-8">
                Technical specifications of our luxury car fleet in Delhi.
              </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600 text-lg">
              Choose from our flexible rental packages for luxury cars in Delhi.
            </p>
          </div>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600 text-lg">
              What our customers say about luxury car rentals in Delhi.
            </p>
          </div>
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-[#e94560] to-[#feca57]">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            Experience Luxury in Delhi
          </h2>
          <p className="text-white/90 text-lg max-w-2xl mx-auto mb-8">
            Book your luxury car today and make a statement in the capital city.
          </p>
          <Link
            href={getLocationUrl("/book")}
