...
import { 
  ...
  FaLuggageCart, FaRoad, FaUniversity
} from "react-icons/fa";
  ...
  const reviews = [
    {
      name: "Vikram Singh",
      rating: 5,
      text: "Perfect family car for Pune trips. Comfortable and spacious.",
      date: "3 days ago"
    },
    {
      name: "Neha Gupta",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-[#00b894]/20 backdrop-blur-sm px-4 py-2 rounded-full mb-4 border border-[#00b894]/30">
                ...
                <span className="text-[#55efc4] font-medium text-sm">Pune - Ertiga</span>
              </div>
              ...
              <p className="text-lg text-gray-300 mb-6">
                Perfect family car for Pune's cultural streets. The Ertiga offers spacious 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-gray-600 mb-8">
                The Ertiga comes with family-friendly features for a comfortable Pune journey.
              </p>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600 text-lg">
              What our customers say about the Ertiga in Pune.
            </p>
          </div>
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-[#00b894] to-[#55efc4]">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-white/90 text-lg max-w-2xl mx-auto mb-8">
            Book the perfect family car for your Pune trips today.
          </p>
          <Link
            href={getLocationUrl("/book")}
