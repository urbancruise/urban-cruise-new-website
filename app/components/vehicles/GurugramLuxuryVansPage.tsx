...
import { 
  ...
  FaCoffee, FaChargingStation, FaBuilding,
  FaUmbrella
} from "react-icons/fa";
...
export default function GurugramLuxuryVansPage() {
  ...
  const vehicleImages = [
    "/images/vehicles/luxury-van-main.jpg",
    "/images/vehicles/luxury-van-1.jpg",
    "/images/vehicles/luxury-van-2.jpg",
    "/images/vehicles/luxury-van-3.jpg",
  ];

  const features = [
    { icon: FaUsers, label: "Seats", value: "8-12" },
  ...
  const specs = [
    { label: "Model", value: "Toyota HiAce / Mercedes V-Class" },
  ...
  const reviews = [
    {
      ...
      rating: 5,
      text: "The luxury van was perfect for our corporate event in Gurugram. Comfortable and spacious!",
      date: "2 days ago"
    },
    {
      name: "Ms. Neha Gupta",
      rating: 5,
      text: "Excellent service! The van was pristine and the chauffeur was very professional.",
      date: "4 days ago"
    },
    {
      name: "Dr. Rajiv Malhotra",
      rating: 5,
      text: "Best luxury van service in Gurugram. Perfect for corporate group travel.",
      date: "1 week ago"
    },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-[#6c5ce7]/20 backdrop-blur-sm px-4 py-2 rounded-full mb-4 border border-[#6c5ce7]/30">
                ...
                <span className="text-[#a29bfe] font-medium text-sm">Gurugram - Luxury Vans</span>
              </div>
              ...
              <p className="text-lg text-gray-300 mb-6">
                Travel in style and comfort with our premium luxury vans in Gurugram. 
                Perfect for corporate events, business group travel, and VIP transport.
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-gray-600 mb-8">
                Our luxury vans come with premium features for group travel.
              </p>
            ...
            <div>
              ...
              <p className="text-gray-600 mb-8">
                Technical specifications of our luxury vans.
              </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600 text-lg">
              Choose from our flexible rental packages for luxury vans.
            </p>
          </div>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600 text-lg">
              What our customers say about our luxury vans in Gurugram.
            </p>
          </div>
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-[#6c5ce7] to-[#8b7cf7]">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-white/90 text-lg max-w-2xl mx-auto mb-8">
            Book your luxury van today and experience group travel in style.
          </p>
          <Link
            href={getLocationUrl("/book")}
