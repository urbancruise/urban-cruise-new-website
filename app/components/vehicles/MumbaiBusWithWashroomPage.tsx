  ...
  const reviews = [
    {
      ...
      rating: 5,
      text: "The Bus with Washroom was a game-changer for our long-distance film shoots in Mumbai. So convenient!",
      date: "1 day ago"
    },
    {
    ...
    },
    {
      name: "Mr. Amit Shah",
      rating: 5,
      text: "The best bus service for celebrity travel in Mumbai. Highly recommended!",
      date: "5 days ago"
    },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-[#ff6b6b]/20 backdrop-blur-sm px-4 py-2 rounded-full mb-4 border border-[#ff6b6b]/30">
                ...
                <span className="text-[#ff6b6b] font-medium text-sm">Mumbai - Bus With Washroom</span>
              </div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight mb-4">
                Premium <span className="bg-gradient-to-r from-[#ff6b6b] to-[#feca57] bg-clip-text text-transparent">Bus With Washroom</span><br />in Mumbai
              </h1>
              <p className="text-lg text-gray-300 mb-6">Experience the ultimate comfort with our Bus With Washroom. Perfect for long-distance film shoots, celebrity travel, and group tours in Mumbai.</p>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              <h2 className="text-2xl md:text-3xl font-bold text-[#0c0c1e] mb-6">Vehicle Features</h2>
                ...
                {features.map((feature, index) => (
                  <div key={index} className="bg-white p-4 rounded-xl shadow-sm">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-full bg-[#ff6b6b]/10 flex items-center justify-center text-[#ff6b6b]"><feature.icon /></div>
                      <div><p className="text-xs text-gray-500">{feature.label}</p><p className="font-semibold text-[#0c0c1e]">{feature.value}</p></div>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div>
              <h2 className="text-2xl md:text-3xl font-bold text-[#0c0c1e] mb-6">Specifications</h2>
      ...
      <section id="packages" className="py-16 md:py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-[#0c0c1e] mb-4">Rental Packages</h2>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600 text-lg">What our customers say about the Bus With Washroom in Mumbai.</p>
          </div>
