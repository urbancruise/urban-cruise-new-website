...
import { 
  ...
  FaGem, FaWifi, FaMusic, FaUniversity,
  FaBook, FaMountain
} from "react-icons/fa";
import { IoMdArrowForward } from "react-icons/io";
import { useState } from "react";

export default function PuneLuxuryCarsSuvsPage() {
  ...
  const reviews = [
    {
      name: "Dr. Meera Joshi",
      rating: 5,
      text: "The BMW 5 Series was perfect for our heritage tour in Pune. Luxury and comfort combined!",
      date: "2 days ago"
    },
    {
      name: "Prof. Rajesh Kumar",
      rating: 5,
      text: "Excellent service! The Mercedes was pristine and the chauffeur was very professional.",
      date: "4 days ago"
    },
    {
      name: "Mr. Ananya Patel",
      rating: 5,
      text: "The best luxury car service in Pune. Highly recommended for special occasions.",
      date: "1 week ago"
    },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-[#00b894]/20 backdrop-blur-sm px-4 py-2 rounded-full mb-4 border border-[#00b894]/30">
                ...
                <span className="text-[#55efc4] font-medium text-sm">Pune - Luxury Cars & SUVs</span>
              </div>
              ...
              <p className="text-lg text-gray-300 mb-6">
                Explore the cultural capital of Maharashtra in style. Our luxury car fleet 
                is perfect for heritage tours, special occasions, and business travel in Pune.
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-gray-600 mb-8">
                Our luxury cars come with premium features for an unmatched Pune experience.
              </p>
            ...
            <div>
              ...
              <p className="text-gray-600 mb-8">
                Technical specifications of our luxury car fleet in Pune.
              </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600 text-lg">
              Choose from our flexible rental packages for luxury cars in Pune.
            </p>
          </div>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600 text-lg">
              What our customers say about luxury car rentals in Pune.
            </p>
          </div>
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-[#00b894] to-[#55efc4]">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            Experience Luxury in Pune
          </h2>
          <p className="text-white/90 text-lg max-w-2xl mx-auto mb-8">
            Book your luxury car today and explore the cultural capital in style.
          </p>
          <Link
            href={getLocationUrl("/book")}
