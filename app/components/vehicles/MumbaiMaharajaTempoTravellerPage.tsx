...
import { 
  ...
  FaUmbrella, FaGlassCheers, FaFilm,
  FaUmbrellaBeach
} from "react-icons/fa";
import { IoMdArrowForward } from "react-icons/io";
import { useState } from "react";

export default function MumbaiMaharajaTempoTravellerPage() {
  ...
  const reviews = [
    {
      ...
      rating: 5,
      text: "The Maharaja Tempo Traveller is perfect for celebrity groups in Mumbai. Royal experience!",
      date: "1 day ago"
    },
    {
    ...
    },
    {
      name: "Mr. Amit Shah",
      rating: 5,
      text: "The best luxury group travel experience in Mumbai. Highly recommended for film shoots!",
      date: "5 days ago"
    },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-[#ff6b6b]/20 backdrop-blur-sm px-4 py-2 rounded-full mb-4 border border-[#ff6b6b]/30">
                ...
                <span className="text-[#ff6b6b] font-medium text-sm">Mumbai - Maharaja Tempo Traveller</span>
              </div>
              ...
              <p className="text-lg text-gray-300 mb-6">
                ...
                celebrity groups, film shoots, and special occasions in Mumbai.
              </p>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600 text-lg">
              What our customers say about the Maharaja Tempo Traveller in Mumbai.
            </p>
          </div>
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-[#ff6b6b] to-[#ff9a9a]">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-white/90 text-lg max-w-2xl mx-auto mb-8">
            Book the Maharaja Tempo Traveller today and experience royal travel in Mumbai.
          </p>
          <Link
            href={getLocationUrl("/book")}
