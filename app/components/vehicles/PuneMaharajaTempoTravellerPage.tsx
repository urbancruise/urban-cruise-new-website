...
import { 
  ...
  FaUmbrella, FaGlassCheers, FaUniversity,
  FaBook, FaMountain
} from "react-icons/fa";
  ...
  const reviews = [
    {
      name: "Dr. Meera Joshi",
      rating: 5,
      text: "The Maharaja Tempo Traveller is perfect for heritage VIP groups in Pune. Royal experience!",
      date: "1 day ago"
    },
    {
    ...
    },
    {
      ...
      rating: 5,
      text: "The best luxury group travel experience in Pune. Highly recommended for heritage tours!",
      date: "5 days ago"
    },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-[#00b894]/20 backdrop-blur-sm px-4 py-2 rounded-full mb-4 border border-[#00b894]/30">
                ...
                <span className="text-[#55efc4] font-medium text-sm">Pune - Maharaja Tempo Traveller</span>
              </div>
              ...
              <p className="text-lg text-gray-300 mb-6">
                ...
                heritage VIP groups, educational tours, and special occasions in Pune.
              </p>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap justify-center gap-6 text-center">
            <div className="flex items-center gap-2 text-[#0a1a0a]">
              ...
              <span>Heritage VIP</span>
            </div>
            <div className="flex items-center gap-2 text-[#0a1a0a]">
              <FaCrown className="text-[#00b894] text-xl" />
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600 text-lg">
              What our customers say about the Maharaja Tempo Traveller in Pune.
            </p>
          </div>
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-[#00b894] to-[#55efc4]">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-white/90 text-lg max-w-2xl mx-auto mb-8">
            Book the Maharaja Tempo Traveller today and experience royal travel in Pune.
          </p>
          <Link
            href={getLocationUrl("/book")}
