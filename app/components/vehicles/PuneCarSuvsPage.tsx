...
import { 
  ...
  FaPhone, FaEnvelope, FaCalendarCheck, FaUniversity,
  FaBook, FaMountain
} from "react-icons/fa";
  ...
  const reviews = [
    {
      name: "Dr. Meera Joshi",
      rating: 5,
      text: "Great car rental service in Pune. The car was clean and well-maintained.",
      date: "2 days ago"
    },
    {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-[#00b894]/20 backdrop-blur-sm px-4 py-2 rounded-full mb-4 border border-[#00b894]/30">
                ...
                <span className="text-[#55efc4] font-medium text-sm">Pune - Car & SUVs</span>
              </div>
              ...
              <p className="text-lg text-gray-300 mb-6">
                Explore the Oxford of the East in style with our premium fleet of cars and SUVs. 
                Perfect for heritage tours, educational visits, and cultural exploration.
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-gray-600 mb-8">
                Our Car & SUVs come equipped with modern features for a comfortable Pune experience.
              </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600 text-lg">
              Choose from our flexible rental packages designed for Pune.
            </p>
          </div>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600 text-lg">
              What our customers say about our Car & SUVs in Pune.
            </p>
          </div>
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-[#00b894] to-[#55efc4]">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            Ready to Drive in Pune?
          </h2>
          <p className="text-white/90 text-lg max-w-2xl mx-auto mb-8">
            Book your premium Car or SUV today and experience Pune in comfort and style.
          </p>
          <Link
            href={getLocationUrl("/book")}
