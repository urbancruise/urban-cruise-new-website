...
import { 
  ...
  FaChargingStation, FaUmbrella, FaBuilding
} from "react-icons/fa";
import { IoMdArrowForward } from "react-icons/io";
import { useState } from "react";

export default function GurugramTempoTravellerPage() {
  const { getLocationUrl, location } = useLocation();
  const [selectedImage, setSelectedImage] = useState(0);

  const vehicleImages = [
    "/images/vehicles/tempo-traveller-main.jpg",
    "/images/vehicles/tempo-traveller-1.jpg",
    "/images/vehicles/tempo-traveller-2.jpg",
    "/images/vehicles/tempo-traveller-3.jpg",
  ];

  const features = [
    { icon: FaUsers, label: "Seats", value: "9-12" },
    { icon: FaBus, label: "Type", value: "Tempo Traveller" },
    ...
    { icon: FaShieldAlt, label: "Safety", value: "Seat Belts" },
    { icon: FaTrophy, label: "Rating", value: "4.7★" },
    { icon: FaWifi, label: "Connectivity", value: "WiFi" },
    { icon: FaUmbrella, label: "Roof", value: "High Roof" },
  ];

  const specs = [
    { label: "Model", value: "Tempo Traveller" },
    { label: "Engine", value: "2.5L Diesel" },
    { label: "Transmission", value: "Manual" },
    { label: "Mileage", value: "12-14 km/L" },
    { label: "Fuel Tank", value: "60 L" },
    { label: "Boot Space", value: "1000-1500 L" },
  ];
  ...
  const packages = [
    ...
    },
    {
      ...
      price: "₹3,500",
      km: "Up to 25 KM",
      features: ["One way", "Driver included", "Fuel included", "AC"]
    },
    {
      name: "Outstation",
      duration: "Per Day",
      price: "₹11,000",
      km: "250 KM",
      features: ["Intercity travel", "Driver included", "Fuel included", "AC"]
    },
  ];
  ...
  const reviews = [
    {
      ...
      rating: 5,
      text: "Perfect for our corporate group travel in Gurugram. The Tempo Traveller was comfortable and spacious.",
      date: "2 days ago"
    },
    {
      name: "Ms. Neha Gupta",
      rating: 5,
      text: "Excellent service! The vehicle was clean and the driver was professional.",
      date: "4 days ago"
    },
    {
      name: "Dr. Rajiv Malhotra",
      rating: 4,
      text: "Great value for money. Perfect for business group travel in Gurugram.",
      date: "1 week ago"
    },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-[#6c5ce7]/20 backdrop-blur-sm px-4 py-2 rounded-full mb-4 border border-[#6c5ce7]/30">
                ...
                <span className="text-[#a29bfe] font-medium text-sm">Gurugram - Tempo Traveller</span>
              </div>
              ...
              <p className="text-lg text-gray-300 mb-6">
                Travel with your group in comfort and style. Our Tempo Traveller is perfect 
                for corporate events, group tours, and business travel in Gurugram.
              </p>
      ...
      <section className="py-8 bg-gradient-to-r from-[#6c5ce7]/10 to-[#a29bfe]/10">
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap justify-center gap-6 text-center">
            ...
            <div className="flex items-center gap-2 text-[#0c0c1d]">
              <FaUsers className="text-[#6c5ce7] text-xl" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-gray-600 mb-8">
                Our Tempo Traveller comes with all the features for a comfortable group journey.
              </p>
            ...
            <div>
              ...
              <p className="text-gray-600 mb-8">
                Technical specifications of our Tempo Traveller.
              </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600 text-lg">
              Choose from our flexible rental packages for the Tempo Traveller.
            </p>
          </div>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600 text-lg">
              What our customers say about the Tempo Traveller in Gurugram.
            </p>
          </div>
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-[#6c5ce7] to-[#8b7cf7]">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-white/90 text-lg max-w-2xl mx-auto mb-8">
            Book your Tempo Traveller today and explore Gurugram with your group.
          </p>
          <Link
            href={getLocationUrl("/book")}
