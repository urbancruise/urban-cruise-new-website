...
export default function GurugramMiniBusPage() {
  ...
  const vehicleImages = [
    "/images/vehicles/mini-bus-main.jpg",
    "/images/vehicles/mini-bus-1.jpg",
    "/images/vehicles/mini-bus-2.jpg",
    "/images/vehicles/mini-bus-3.jpg",
  ];

  const features = [
    { icon: FaUsers, label: "Seats", value: "18-22" },
    { icon: FaBus, label: "Type", value: "Mini Bus" },
    ...
    { icon: FaGem, label: "Interior", value: "Comfort Finish" },
  ];

  const specs = [
    { label: "Model", value: "Mini Bus" },
    { label: "Engine", value: "2.8L Diesel" },
    { label: "Transmission", value: "Manual" },
    { label: "Mileage", value: "10-12 km/L" },
    { label: "Fuel Tank", value: "80 L" },
    { label: "Boot Space", value: "2500-3000 L" },
  ];
  ...
  const packages = [
    ...
    },
    {
      ...
      price: "₹15,000",
      km: "250 KM",
      features: ["Intercity travel", "Driver included", "Fuel included", "Comfort experience"]
    },
  ];
  ...
  const reviews = [
    {
      ...
      rating: 5,
      text: "Perfect for our corporate event in Gurugram. The Mini Bus was comfortable and spacious!",
      date: "1 day ago"
    },
    {
      name: "Ms. Neha Gupta",
      rating: 5,
      text: "Excellent service! The Mini Bus was clean and the driver was professional.",
      date: "3 days ago"
    },
    {
      name: "Dr. Rajiv Malhotra",
      rating: 4,
      text: "Great value for money. Perfect for large corporate groups in Gurugram.",
      date: "5 days ago"
    },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-[#6c5ce7]/20 backdrop-blur-sm px-4 py-2 rounded-full mb-4 border border-[#6c5ce7]/30">
                ...
                <span className="text-[#a29bfe] font-medium text-sm">Gurugram - Mini Bus</span>
              </div>
              ...
              <p className="text-lg text-gray-300 mb-6">
                Travel with large groups in comfort and style. Our Mini Bus is perfect for 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-gray-600 mb-8">
                Our Mini Bus comes with all the features for a comfortable group journey.
              </p>
            ...
            <div>
              ...
              <p className="text-gray-600 mb-8">
                Technical specifications of our Mini Bus.
              </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600 text-lg">
              Choose from our flexible rental packages for the Mini Bus.
            </p>
          </div>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600 text-lg">
              What our customers say about the Mini Bus in Gurugram.
            </p>
          </div>
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-[#6c5ce7] to-[#8b7cf7]">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-white/90 text-lg max-w-2xl mx-auto mb-8">
            Book your Mini Bus today and explore Gurugram with your group.
          </p>
          <Link
            href={getLocationUrl("/book")}
