  ...
  const reviews = [
    {
      name: "Rajesh Gupta",
      rating: 5,
      text: "Great car rental service in Gurugram. The car was clean and well-maintained.",
      date: "2 days ago"
    },
    {
      name: "Priya Sharma",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-[#6c5ce7]/20 backdrop-blur-sm px-4 py-2 rounded-full mb-4 border border-[#6c5ce7]/30">
                ...
                <span className="text-[#a29bfe] font-medium text-sm">Gurugram - Car & SUVs</span>
              </div>
              ...
              <p className="text-lg text-gray-300 mb-6">
                Explore Gurugram in style with our premium fleet of cars and SUVs. 
                Perfect for corporate travel, client meetings, and business trips.
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-gray-600 mb-8">
                Our Car & SUVs come equipped with modern features for corporate and business travel.
              </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600 text-lg">
              Choose from our flexible rental packages designed for corporate needs.
            </p>
          </div>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600 text-lg">
              What our corporate clients say about our Car & SUVs in Gurugram.
            </p>
          </div>
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-[#6c5ce7] to-[#8b7cf7]">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            Ready to Drive in Gurugram?
          </h2>
          <p className="text-white/90 text-lg max-w-2xl mx-auto mb-8">
            Book your premium Car or SUV today and experience Gurugram in comfort and style.
          </p>
          <Link
            href={getLocationUrl("/book")}
