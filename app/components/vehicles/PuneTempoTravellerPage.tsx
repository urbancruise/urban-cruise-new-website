...
import { 
  ...
  FaChargingStation, FaUmbrella, FaUniversity,
  FaBook, FaMountain
} from "react-icons/fa";
  ...
  const reviews = [
    {
      name: "Dr. Meera Joshi",
      rating: 5,
      text: "Perfect for our heritage group tour in Pune. The Tempo Traveller was comfortable and spacious.",
      date: "2 days ago"
    },
    {
    ...
    },
    {
      ...
      rating: 4,
      text: "Great value for money. Perfect for educational trips in Pune.",
      date: "1 week ago"
    },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-[#00b894]/20 backdrop-blur-sm px-4 py-2 rounded-full mb-4 border border-[#00b894]/30">
                ...
                <span className="text-[#55efc4] font-medium text-sm">Pune - Tempo Traveller</span>
              </div>
              ...
              <p className="text-lg text-gray-300 mb-6">
                ...
                for heritage tours, educational trips, and group events in Pune.
              </p>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600 text-lg">
              What our customers say about the Tempo Traveller in Pune.
            </p>
          </div>
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-[#00b894] to-[#55efc4]">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-white/90 text-lg max-w-2xl mx-auto mb-8">
            Book your Tempo Traveller today and explore Pune with your group.
          </p>
          <Link
            href={getLocationUrl("/book")}
