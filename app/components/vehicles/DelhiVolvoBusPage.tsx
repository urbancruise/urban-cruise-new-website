// app/components/vehicles/DelhiVolvoBusPage.tsx
"use client";
...
export default function DelhiVolvoBusPage() {
  ...
  const reviews = [
    {
      ...
      rating: 5,
      text: "The Volvo Bus is the epitome of luxury group travel in Delhi. Highly recommended!",
      date: "1 day ago"
    },
    {
    ...
    },
    {
      ...
      rating: 5,
      text: "The best luxury bus service in Delhi. Perfect for large group tours.",
      date: "5 days ago"
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-[#e94560]/20 backdrop-blur-sm px-4 py-2 rounded-full mb-4 border border-[#e94560]/30">
                ...
                <span className="text-[#e94560] font-medium text-sm">Delhi - Volvo Bus</span>
              </div>
      ...
      {/* Features & Specs - Same as Luxury Bus but with Volvo specific content */}
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600 text-lg">
              What our customers say about the Volvo Bus in Delhi.
            </p>
          </div>
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-[#e94560] to-[#feca57]">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-white/90 text-lg max-w-2xl mx-auto mb-8">
            Book your Volvo Bus today and experience luxury group travel in Delhi.
          </p>
          <Link
            href={getLocationUrl("/book")}
