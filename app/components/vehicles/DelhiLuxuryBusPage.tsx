  ...
  const reviews = [
    {
      ...
      rating: 5,
      text: "The Luxury Bus was perfect for our large group tour in Delhi. Comfortable and spacious!",
      date: "2 days ago"
    },
    {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-[#e94560]/20 backdrop-blur-sm px-4 py-2 rounded-full mb-4 border border-[#e94560]/30">
                ...
                <span className="text-[#e94560] font-medium text-sm">Delhi - Luxury Bus</span>
              </div>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600 text-lg">
              What our customers say about the Luxury Bus in Delhi.
            </p>
          </div>
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-[#e94560] to-[#feca57]">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-white/90 text-lg max-w-2xl mx-auto mb-8">
            Book your Luxury Bus today and explore Delhi with your group.
          </p>
          <Link
            href={getLocationUrl("/book")}
