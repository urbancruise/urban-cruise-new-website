...
export default function PuneHycrossPage() {
  ...
  const reviews = [
    ...
    },
    {
      name: "Sneha Reddy",
      rating: 5,
      text: "Luxury meets eco-friendly. The Hycross is perfect for Pune's heritage tours.",
      date: "3 days ago"
    },
    {
      name: "Vikram Singh",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-[#00b894]/20 backdrop-blur-sm px-4 py-2 rounded-full mb-4 border border-[#00b894]/30">
                ...
                <span className="text-[#55efc4] font-medium text-sm">Pune - Hycross</span>
              </div>
              ...
              <p className="text-lg text-gray-300 mb-6">
                ...
                comfort with hybrid efficiency for an eco-friendly Pune experience.
              </p>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600 text-lg">
              What our customers say about the Hycross in Pune.
            </p>
          </div>
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-[#00b894] to-[#55efc4]">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-white/90 text-lg max-w-2xl mx-auto mb-8">
            Experience the future of luxury mobility in Pune. Book your Hycross today.
          </p>
          <Link
            href={getLocationUrl("/book")}
