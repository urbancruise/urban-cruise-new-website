...
import { 
  ...
  FaGem, FaWifi, FaMusic, FaFilm,
  FaUmbrellaBeach
} from "react-icons/fa";
import { IoMdArrowForward } from "react-icons/io";
import { useState } from "react";

export default function MumbaiLuxuryCarsSuvsPage() {
  ...
  const specs = [
    { label: "Model", value: "Mercedes-Benz S-Class / Audi A8" },
  ...
  const reviews = [
    {
      ...
      rating: 5,
      text: "The S-Class is the epitome of luxury. Perfect for Mumbai's celebrity lifestyle.",
      date: "1 day ago"
    },
    {
      name: "Ms. Priyanka (Team)",
      rating: 5,
      text: "Immaculate service and pristine vehicles. Urban Cruise is the best in Mumbai.",
      date: "4 days ago"
    },
    {
      name: "Mr. Amit Shah",
      rating: 5,
      text: "The Audi A8 was stunning! Perfect for our corporate event in Mumbai.",
      date: "1 week ago"
    },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-[#ff6b6b]/20 backdrop-blur-sm px-4 py-2 rounded-full mb-4 border border-[#ff6b6b]/30">
                ...
                <span className="text-[#ff6b6b] font-medium text-sm">Mumbai - Luxury Cars & SUVs</span>
              </div>
              ...
              <p className="text-lg text-gray-300 mb-6">
                Cruise through the city of dreams in style. Our luxury car fleet in Mumbai 
                is perfect for celebrities, executives, and those who appreciate the finer things.
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-gray-600 mb-8">
                Our luxury cars come with premium features for an unparalleled Mumbai experience.
              </p>
            ...
            <div>
              ...
              <p className="text-gray-600 mb-8">
                Technical specifications of our luxury car fleet in Mumbai.
              </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600 text-lg">
              Choose from our flexible rental packages for luxury cars in Mumbai.
            </p>
          </div>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600 text-lg">
              What our customers say about luxury car rentals in Mumbai.
            </p>
          </div>
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-[#ff6b6b] to-[#ff9a9a]">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            Experience Luxury in Mumbai
          </h2>
          <p className="text-white/90 text-lg max-w-2xl mx-auto mb-8">
            Book your luxury car today and cruise through Maximum City in style.
          </p>
          <Link
            href={getLocationUrl("/book")}
