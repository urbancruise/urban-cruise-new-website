...
export default function GurugramInnovaCrystaPage() {
  ...
  const reviews = [
    {
      name: "Amit Sharma",
      rating: 5,
      text: "The Innova Crysta is the best MPV for Gurugram corporate travel. Comfortable and powerful.",
      date: "2 days ago"
    },
    {
      name: "Priya Verma",
    ...
    },
    {
      name: "Suresh Patel",
      rating: 5,
      text: "Perfect for corporate events and family trips. Highly recommend this vehicle.",
      date: "1 week ago"
    },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-[#6c5ce7]/20 backdrop-blur-sm px-4 py-2 rounded-full mb-4 border border-[#6c5ce7]/30">
                ...
                <span className="text-[#a29bfe] font-medium text-sm">Gurugram - Innova Crysta</span>
              </div>
              ...
              <p className="text-lg text-gray-300 mb-6">
                ...
                space, and performance for your corporate and personal journeys in Gurugram.
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-gray-600 mb-8">
                The Innova Crysta comes with premium features for a luxurious corporate experience.
              </p>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600 text-lg">
              What our customers say about the Innova Crysta in Gurugram.
            </p>
          </div>
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-[#6c5ce7] to-[#8b7cf7]">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-white/90 text-lg max-w-2xl mx-auto mb-8">
            Experience the king of MPVs in Gurugram. Book your Innova Crysta today.
          </p>
          <Link
            href={getLocationUrl("/book")}
