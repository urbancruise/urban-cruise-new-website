  ...
  const reviews = [
    {
      ...
      rating: 5,
      text: "The Urbania is perfect for film shoots and celebrity groups in Mumbai. Premium and comfortable!",
      date: "1 day ago"
    },
    {
    ...
    },
    {
      name: "Mr. Amit Shah",
      rating: 5,
      text: "The best premium mini bus service in Mumbai. Perfect for VIP groups and special occasions.",
      date: "5 days ago"
    },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-[#ff6b6b]/20 backdrop-blur-sm px-4 py-2 rounded-full mb-4 border border-[#ff6b6b]/30">
                ...
                <span className="text-[#ff6b6b] font-medium text-sm">Mumbai - Force Urbania</span>
              </div>
      ...
      <section className="py-8 bg-gradient-to-r from-[#ff6b6b]/10 to-[#feca57]/10">
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap justify-center gap-6 text-center">
            ...
            <div className="flex items-center gap-2 text-[#0c0c1e]">
              <FaCity className="text-[#ff6b6b] text-xl" />
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600 text-lg">
              What our customers say about the Force Urbania in Mumbai.
            </p>
          </div>
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-[#ff6b6b] to-[#ff9a9a]">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-white/90 text-lg max-w-2xl mx-auto mb-8">
            Book the Force Urbania today and experience premium group travel in Mumbai.
          </p>
          <Link
            href={getLocationUrl("/book")}
