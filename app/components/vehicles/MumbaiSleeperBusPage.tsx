  ...
  const reviews = [
    {
      ...
      rating: 5,
      text: "The Sleeper Bus was perfect for our overnight film shoots in Mumbai. So comfortable and spacious!",
      date: "1 day ago"
    },
    {
    ...
    },
    {
      name: "Mr. Amit Shah",
      rating: 5,
      text: "The best sleeper bus service in Mumbai. Perfect for long-distance celebrity travel.",
      date: "5 days ago"
    },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-[#ff6b6b]/20 backdrop-blur-sm px-4 py-2 rounded-full mb-4 border border-[#ff6b6b]/30">
                ...
                <span className="text-[#ff6b6b] font-medium text-sm">Mumbai - Sleeper Bus</span>
              </div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight mb-4">
                Premium <span className="bg-gradient-to-r from-[#ff6b6b] to-[#feca57] bg-clip-text text-transparent">Sleeper Bus</span><br />in Mumbai
              </h1>
              <p className="text-lg text-gray-300 mb-6">Experience the ultimate comfort with our Sleeper | Semi Sleeper Bus. Perfect for overnight film shoots, long-distance celebrity travel, and group tours in Mumbai.</p>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600 text-lg">What our customers say about the Sleeper Bus in Mumbai.</p>
          </div>
