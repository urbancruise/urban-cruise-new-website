  ...
  const reviews = [
    {
      ...
      rating: 5,
      text: "The luxury van was perfect for our film shoot in Mumbai. Comfortable and spacious!",
      date: "1 day ago"
    },
    {
    ...
    },
    {
      name: "Mr. Amit Shah",
      rating: 5,
      text: "Best luxury van service in Mumbai. Perfect for group tours and celebrity transport.",
      date: "1 week ago"
    },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-[#ff6b6b]/20 backdrop-blur-sm px-4 py-2 rounded-full mb-4 border border-[#ff6b6b]/30">
                ...
                <span className="text-[#ff6b6b] font-medium text-sm">Mumbai - Luxury Vans</span>
              </div>
              ...
              <p className="text-lg text-gray-300 mb-6">
                Travel in style and comfort with our premium luxury vans in Mumbai. 
                Perfect for film shoots, celebrity transport, and group events.
              </p>
      ...
      <section className="py-8 bg-gradient-to-r from-[#ff6b6b]/10 to-[#feca57]/10">
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap justify-center gap-6 text-center">
            ...
            <div className="flex items-center gap-2 text-[#0c0c1e]">
              <FaUtensils className="text-[#ff6b6b] text-xl" />
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600 text-lg">
              What our customers say about our luxury vans in Mumbai.
            </p>
          </div>
