  ...
  const reviews = [
    {
      name: "Dr. Meera Joshi",
      rating: 5,
      text: "The Sleeper Bus was perfect for our overnight heritage tours in Pune. So comfortable and spacious!",
      date: "1 day ago"
    },
    {
    ...
    },
    {
      ...
      rating: 5,
      text: "The best sleeper bus service in Pune. Perfect for long-distance educational group travel.",
      date: "5 days ago"
    },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-[#00b894]/20 backdrop-blur-sm px-4 py-2 rounded-full mb-4 border border-[#00b894]/30">
                ...
                <span className="text-[#55efc4] font-medium text-sm">Pune - Sleeper Bus</span>
              </div>
              ...
              <p className="text-lg text-gray-300 mb-6">
                Experience the ultimate comfort with our Sleeper | Semi Sleeper Bus. Perfect for 
                overnight heritage tours, long-distance educational trips, and group travel in Pune.
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-gray-600 mb-8">
                Our Sleeper Bus comes with premium features for a comfortable overnight journey.
              </p>
            ...
            <div>
              ...
              <p className="text-gray-600 mb-8">
                Technical specifications of our Sleeper Bus.
              </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600 text-lg">
              Choose from our flexible rental packages for the Sleeper Bus.
            </p>
          </div>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600 text-lg">
              What our customers say about the Sleeper Bus in Pune.
            </p>
          </div>
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-[#00b894] to-[#55efc4]">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            Ready for Comfortable Overnight Travel?
          </h2>
          <p className="text-white/90 text-lg max-w-2xl mx-auto mb-8">
            Book your Sleeper Bus today and experience comfort on your journey.
          </p>
          <Link
            href={getLocationUrl("/book")}
