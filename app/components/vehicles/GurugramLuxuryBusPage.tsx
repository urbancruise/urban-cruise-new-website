...
export default function GurugramLuxuryBusPage() {
  ...
  const reviews = [
    {
      ...
      rating: 5,
      text: "The Luxury Bus was perfect for our corporate event in Gurugram. Comfortable and spacious!",
      date: "1 day ago"
    },
    {
      name: "Ms. Neha Gupta",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-[#6c5ce7]/20 backdrop-blur-sm px-4 py-2 rounded-full mb-4 border border-[#6c5ce7]/30">
                ...
                <span className="text-[#a29bfe] font-medium text-sm">Gurugram - Luxury Bus</span>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-gray-600 mb-8">
                Our Luxury Bus comes with premium features for a comfortable group journey.
              </p>
            ...
            <div>
              ...
              <p className="text-gray-600 mb-8">
                Technical specifications of our Luxury Bus.
              </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600 text-lg">
              Choose from our flexible rental packages for the Luxury Bus.
            </p>
          </div>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600 text-lg">
              What our customers say about the Luxury Bus in Gurugram.
            </p>
          </div>
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-[#6c5ce7] to-[#8b7cf7]">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-white/90 text-lg max-w-2xl mx-auto mb-8">
            Book your Luxury Bus today and explore Gurugram with your group.
          </p>
          <Link
            href={getLocationUrl("/book")}
