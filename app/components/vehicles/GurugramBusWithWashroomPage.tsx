...
import { 
  ...
  FaRestroom, FaToilet, FaBuilding
} from "react-icons/fa";
...
export default function GurugramBusWithWashroomPage() {
  ...
  const vehicleImages = [
    "/images/vehicles/bus-washroom-main.jpg",
    "/images/vehicles/bus-washroom-1.jpg",
    "/images/vehicles/bus-washroom-2.jpg",
    "/images/vehicles/bus-washroom-3.jpg",
  ];

  const features = [
    { icon: FaUsers, label: "Seats", value: "30-40" },
    { icon: FaBus, label: "Type", value: "Luxury Bus" },
    { icon: FaRestroom, label: "Washroom", value: "Available" },
    { icon: FaToilet, label: "Toilet", value: "Premium" },
  ...
  const specs = [
    { label: "Model", value: "Luxury Bus With Washroom" },
  ...
  const packages = [
    {
      ...
      price: "₹12,000",
      km: "40 KM",
      features: ["Local travel", "Driver included", "Fuel included", "AC", "Washroom"]
    },
    {
      name: "Full Day",
      duration: "8 Hours",
  ...
  const reviews = [
    {
      ...
      rating: 5,
      text: "The Bus with Washroom was a game-changer for our corporate event travel in Gurugram. So convenient!",
      date: "1 day ago"
    },
    {
      name: "Ms. Neha Gupta",
      rating: 5,
      text: "Excellent service! The bus was pristine and the washroom was clean and well-maintained.",
      date: "3 days ago"
    },
    {
      name: "Dr. Rajiv Malhotra",
      rating: 5,
      text: "The best bus service for corporate travel in Gurugram. Highly recommended!",
      date: "5 days ago"
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-[#6c5ce7]/20 backdrop-blur-sm px-4 py-2 rounded-full mb-4 border border-[#6c5ce7]/30">
                ...
                <span className="text-[#a29bfe] font-medium text-sm">Gurugram - Bus With Washroom</span>
              </div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight mb-4">
                Premium <span className="bg-gradient-to-r from-[#6c5ce7] to-[#a29bfe] bg-clip-text text-transparent">Bus With Washroom</span><br />in Gurugram
              </h1>
              <p className="text-lg text-gray-300 mb-6">Experience the ultimate comfort with our Bus With Washroom. Perfect for long-distance corporate travel, events, and group tours in Gurugram.</p>
            ...
            <div className="relative">
              <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-4 border border-white/10">
                <div className="relative h-[300px] md:h-[350px] rounded-xl overflow-hidden">
                  <Image src={vehicleImages[selectedImage]} alt="Bus With Washroom" fill className="object-cover" />
                </div>
      ...
      {/* Features & Specs - Same pattern as above */}
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              <h2 className="text-2xl md:text-3xl font-bold text-[#0c0c1d] mb-6">Vehicle Features</h2>
              <p className="text-gray-600 mb-8">Our Bus With Washroom comes with premium features for the ultimate comfort.</p>
              <div className="grid grid-cols-2 gap-4">
                {features.map((feature, index) => (
                  <div key={index} className="bg-white p-4 rounded-xl shadow-sm">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-full bg-[#6c5ce7]/10 flex items-center justify-center text-[#6c5ce7]"><feature.icon /></div>
                      <div><p className="text-xs text-gray-500">{feature.label}</p><p className="font-semibold text-[#0c0c1d]">{feature.value}</p></div>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div>
              <h2 className="text-2xl md:text-3xl font-bold text-[#0c0c1d] mb-6">Specifications</h2>
              <p className="text-gray-600 mb-8">Technical specifications of our Bus With Washroom.</p>
              <div className="bg-white rounded-xl shadow-sm overflow-hidden">
                {specs.map((spec, index) => (
                  <div key={index} className={`flex justify-between items-center p-4 ${index % 2 === 0 ? 'bg-white' : 'bg-gray-50'}`}>
                    <span className="text-gray-600">{spec.label}</span>
                    <span className="font-semibold text-[#0c0c1d]">{spec.value}</span>
                  </div>
                ))}
              </div>
            </div>
      ...
      <section id="packages" className="py-16 md:py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-[#0c0c1d] mb-4">Rental Packages</h2>
            <p className="text-gray-600 text-lg">Choose from our flexible rental packages for the Bus With Washroom.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {packages.map((pkg, index) => (
              <div key={index} className="bg-gray-50 rounded-xl p-6 hover:shadow-lg transition-all duration-300 hover:-translate-y-1 border border-gray-100">
                ...
                <div className="text-sm text-gray-500 mb-4">{pkg.duration} • {pkg.km}</div>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600 text-lg">What our customers say about the Bus With Washroom in Gurugram.</p>
          </div>
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-[#6c5ce7] to-[#8b7cf7]">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Ready for Comfortable Group Travel?</h2>
          <p className="text-white/90 text-lg max-w-2xl mx-auto mb-8">Book your Bus With Washroom today and experience comfort on the go.</p>
