...
import { 
  ...
  FaPhone, FaEnvelope, FaCalendarCheck, FaUmbrellaBeach,
  FaFilm
} from "react-icons/fa";
...
export default function MumbaiCarSuvsPage() {
  ...
  const reviews = [
    {
      name: "Shah Rukh (Staff)",
      rating: 5,
      text: "Great car rental service in Mumbai. The car was clean and well-maintained.",
      date: "2 days ago"
    },
    {
      name: "Priya Chopra",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-[#ff6b6b]/20 backdrop-blur-sm px-4 py-2 rounded-full mb-4 border border-[#ff6b6b]/30">
                ...
                <span className="text-[#ff6b6b] font-medium text-sm">Mumbai - Car & SUVs</span>
              </div>
              ...
              <p className="text-lg text-gray-300 mb-6">
                Explore Maximum City in style with our premium fleet of cars and SUVs. 
                Perfect for Bollywood tours, coastal drives, and city exploration.
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-gray-600 mb-8">
                Our Car & SUVs come equipped with modern features for a comfortable Mumbai experience.
              </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600 text-lg">
              Choose from our flexible rental packages designed for Mumbai.
            </p>
          </div>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600 text-lg">
              What our customers say about our Car & SUVs in Mumbai.
            </p>
          </div>
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-[#ff6b6b] to-[#ff9a9a]">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            Ready to Drive in Mumbai?
          </h2>
          <p className="text-white/90 text-lg max-w-2xl mx-auto mb-8">
            Book your premium Car or SUV today and experience Maximum City in comfort and style.
          </p>
          <Link
            href={getLocationUrl("/book")}
