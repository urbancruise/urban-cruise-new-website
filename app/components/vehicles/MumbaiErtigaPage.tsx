...
import { 
  ...
  FaLuggageCart, FaRoad, FaUmbrellaBeach
} from "react-icons/fa";
  ...
  const reviews = [
    {
      name: "Vikram Singh",
      rating: 5,
      text: "Perfect family car for Mumbai trips. Comfortable and spacious.",
      date: "3 days ago"
    },
    {
      name: "Neha Gupta",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-[#ff6b6b]/20 backdrop-blur-sm px-4 py-2 rounded-full mb-4 border border-[#ff6b6b]/30">
                ...
                <span className="text-[#ff6b6b] font-medium text-sm">Mumbai - Ertiga</span>
              </div>
              ...
              <p className="text-lg text-gray-300 mb-6">
                Perfect family car for Mumbai's streets. The Ertiga offers spacious 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-gray-600 mb-8">
                The Ertiga comes with family-friendly features for a comfortable Mumbai journey.
              </p>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600 text-lg">
              What our customers say about the Ertiga in Mumbai.
            </p>
          </div>
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-[#ff6b6b] to-[#ff9a9a]">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-white/90 text-lg max-w-2xl mx-auto mb-8">
            Book the perfect family car for your Mumbai trips today.
          </p>
          <Link
            href={getLocationUrl("/book")}
