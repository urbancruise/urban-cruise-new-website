...
export default function GurugramUrbaniaPage() {
  ...
  const vehicleImages = [
    "/images/vehicles/urbania-main.jpg",
    "/images/vehicles/urbania-1.jpg",
    "/images/vehicles/urbania-2.jpg",
    "/images/vehicles/urbania-3.jpg",
  ];

  const features = [
    { icon: FaUsers, label: "Seats", value: "13-17" },
    { icon: FaBus, label: "Type", value: "Premium Mini Bus" },
  ...
  const specs = [
    { label: "Model", value: "Force Urbania" },
    ...
    { label: "Boot Space", value: "2000-2500 L" },
  ];
  ...
  const packages = [
    {
      ...
      price: "₹7,000",
      km: "40 KM",
      features: ["Local travel", "Driver included", "Fuel included", "Premium AC"]
    },
    {
      name: "Full Day",
      duration: "8 Hours",
    ...
    },
    {
      ...
      price: "₹4,500",
      km: "Up to 25 KM",
      features: ["One way", "Driver included", "Fuel included", "VIP meet & greet"]
    },
    {
      name: "Outstation",
      duration: "Per Day",
  ...
  const reviews = [
    {
      ...
      rating: 5,
      text: "The Urbania is perfect for corporate events in Gurugram. Premium and comfortable!",
      date: "1 day ago"
    },
    {
      name: "Ms. Neha Gupta",
      rating: 5,
      text: "Excellent service! The Urbania was pristine and the chauffeur was very professional.",
      date: "3 days ago"
    },
    {
      name: "Dr. Rajiv Malhotra",
      rating: 5,
      text: "The best premium mini bus service in Gurugram. Perfect for VIP corporate groups.",
      date: "5 days ago"
    },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-[#6c5ce7]/20 backdrop-blur-sm px-4 py-2 rounded-full mb-4 border border-[#6c5ce7]/30">
                ...
                <span className="text-[#a29bfe] font-medium text-sm">Gurugram - Force Urbania</span>
              </div>
              ...
              <p className="text-lg text-gray-300 mb-6">
                Experience premium group travel with the Force Urbania. Perfect for 
                corporate events, business VIP groups, and special occasions in Gurugram.
              </p>
      ...
      <section className="py-8 bg-gradient-to-r from-[#6c5ce7]/10 to-[#a29bfe]/10">
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap justify-center gap-6 text-center">
            ...
            <div className="flex items-center gap-2 text-[#0c0c1d]">
              <FaCity className="text-[#6c5ce7] text-xl" />
              <span>Urban Travel</span>
            </div>
            <div className="flex items-center gap-2 text-[#0c0c1d]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-gray-600 mb-8">
                The Force Urbania comes with premium features for a luxurious group journey.
              </p>
            ...
            <div>
              ...
              <p className="text-gray-600 mb-8">
                Technical specifications of the Force Urbania.
              </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600 text-lg">
              Choose from our flexible rental packages for the Force Urbania.
            </p>
          </div>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600 text-lg">
              What our customers say about the Force Urbania in Gurugram.
            </p>
          </div>
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-[#6c5ce7] to-[#8b7cf7]">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            Ready for Premium Group Travel?
          </h2>
          <p className="text-white/90 text-lg max-w-2xl mx-auto mb-8">
            Book the Force Urbania today and experience premium group travel in Gurugram.
          </p>
          <Link
            href={getLocationUrl("/book")}
