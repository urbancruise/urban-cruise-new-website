...
import { 
  ...
  FaCoffee, FaChargingStation, FaUniversity,
  FaBook, FaMountain, FaTree
} from "react-icons/fa";
  ...
  const reviews = [
    {
      name: "Dr. Meera Joshi",
      rating: 5,
      text: "The luxury van was perfect for our heritage tour in Pune. Comfortable and spacious!",
      date: "2 days ago"
    },
    {
    ...
    },
    {
      ...
      rating: 5,
      text: "Best luxury van service in Pune. Perfect for group tours and educational trips.",
      date: "1 week ago"
    },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-[#00b894]/20 backdrop-blur-sm px-4 py-2 rounded-full mb-4 border border-[#00b894]/30">
                ...
                <span className="text-[#55efc4] font-medium text-sm">Pune - Luxury Vans</span>
              </div>
              ...
              <p className="text-lg text-gray-300 mb-6">
                Travel in style and comfort with our premium luxury vans in Pune. 
                Perfect for heritage tours, educational trips, and group events.
              </p>
      ...
      <section className="py-8 bg-gradient-to-r from-[#00b894]/10 to-[#55efc4]/10">
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap justify-center gap-6 text-center">
            ...
            <div className="flex items-center gap-2 text-[#0a1a0a]">
              <FaTree className="text-[#00b894] text-xl" />
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600 text-lg">
              What our customers say about our luxury vans in Pune.
            </p>
          </div>
