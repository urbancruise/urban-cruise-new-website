...
import { 
  ...
  FaCoffee, FaChargingStation, FaUmbrella
} from "react-icons/fa";
  ...
  const reviews = [
    {
      ...
      rating: 5,
      text: "The luxury van was perfect for our family trip to Delhi. Comfortable and spacious!",
      date: "2 days ago"
    },
    {
      name: "Mrs. Neha Gupta",
    ...
    },
    {
      ...
      rating: 5,
      text: "Best luxury van service in Delhi. Perfect for group tours and family trips.",
      date: "1 week ago"
    },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-[#e94560]/20 backdrop-blur-sm px-4 py-2 rounded-full mb-4 border border-[#e94560]/30">
                ...
                <span className="text-[#e94560] font-medium text-sm">Delhi - Luxury Vans</span>
              </div>
              ...
              <p className="text-lg text-gray-300 mb-6">
                Travel in style and comfort with our premium luxury vans in Delhi. 
                Perfect for family trips, group tours, and corporate events.
              </p>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap justify-center gap-6 text-center">
            <div className="flex items-center gap-2 text-[#1a1a2e]">
              <FaUmbrella className="text-[#e94560] text-xl" />
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600 text-lg">
              What our customers say about our luxury vans in Delhi.
            </p>
          </div>
