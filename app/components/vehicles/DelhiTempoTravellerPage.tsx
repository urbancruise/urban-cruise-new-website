...
import { 
  ...
  FaChargingStation, FaUmbrella
} from "react-icons/fa";
import { IoMdArrowForward } from "react-icons/io";
import { useState } from "react";

export default function DelhiTempoTravellerPage() {
  ...
  const reviews = [
    {
      ...
      rating: 5,
      text: "Perfect for our group trip to Delhi. The Tempo Traveller was comfortable and spacious.",
      date: "2 days ago"
    },
    {
    ...
    },
    {
      ...
      rating: 4,
      text: "Great value for money. Perfect for family and group travel in Delhi.",
      date: "1 week ago"
    },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-[#e94560]/20 backdrop-blur-sm px-4 py-2 rounded-full mb-4 border border-[#e94560]/30">
                ...
                <span className="text-[#e94560] font-medium text-sm">Delhi - Tempo Traveller</span>
              </div>
              ...
              <p className="text-lg text-gray-300 mb-6">
                ...
                for family trips, group tours, and corporate events in Delhi.
              </p>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap justify-center gap-6 text-center">
            <div className="flex items-center gap-2 text-[#1a1a2e]">
              <FaBus className="text-[#e94560] text-xl" />
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600 text-lg">
              What our customers say about the Tempo Traveller in Delhi.
            </p>
          </div>
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-[#e94560] to-[#feca57]">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-white/90 text-lg max-w-2xl mx-auto mb-8">
            Book your Tempo Traveller today and explore Delhi with your group.
          </p>
          <Link
            href={getLocationUrl("/book")}
