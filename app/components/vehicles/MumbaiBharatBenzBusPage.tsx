  ...
  const reviews = [
    {
      ...
      rating: 5,
      text: "The Bharat Benz Bus is perfect for our film crew in Mumbai. Comfortable and reliable!",
      date: "2 days ago"
    },
    {
    ...
    },
    {
      name: "Mr. Amit Shah",
      rating: 4,
      text: "Great value for money. Perfect for large group travel in Mumbai.",
      date: "1 week ago"
    },
  ];
    ...
    <div className="min-h-screen bg-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-[#ff6b6b]/20 backdrop-blur-sm px-4 py-2 rounded-full mb-4 border border-[#ff6b6b]/30">
                ...
                <span className="text-[#ff6b6b] font-medium text-sm">Mumbai - Bharat Benz Bus</span>
              </div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight mb-4">
                Premium <span className="bg-gradient-to-r from-[#ff6b6b] to-[#feca57] bg-clip-text text-transparent">Bharat Benz Bus</span><br />in Mumbai
              </h1>
              <p className="text-lg text-gray-300 mb-6">Travel with large groups in luxury and comfort with our Bharat Benz Bus. Perfect for film shoots, celebrity groups, and special occasions in Mumbai.</p>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600 text-lg">What our customers say about the Bharat Benz Bus in Mumbai.</p>
          </div>
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-[#ff6b6b] to-[#ff9a9a]">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-white/90 text-lg max-w-2xl mx-auto mb-8">Book your Bharat Benz Bus today and explore Mumbai with your group.</p>
