  ...
  const reviews = [
    {
      ...
      rating: 5,
      text: "The Bus with Washroom was a game-changer for our long journey in Delhi. So convenient!",
      date: "1 day ago"
    },
    {
    ...
    },
    {
      ...
      rating: 5,
      text: "The best bus service for long-distance travel in Delhi. Highly recommended!",
      date: "5 days ago"
    },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-[#e94560]/20 backdrop-blur-sm px-4 py-2 rounded-full mb-4 border border-[#e94560]/30">
                ...
                <span className="text-[#e94560] font-medium text-sm">Delhi - Bus With Washroom</span>
              </div>
              ...
              <p className="text-lg text-gray-300 mb-6">
                ...
                long-distance travel, corporate events, and group tours in Delhi.
              </p>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600 text-lg">
              What our customers say about the Bus With Washroom in Delhi.
            </p>
          </div>
