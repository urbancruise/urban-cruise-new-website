// components/home/faq's/GurugramFaq's.tsx
"use client";
  ...
  return (
    <motion.div
      ...
      className={`
        ...
        ${
          isOpen
            ? "shadow-[0_7px_22px_rgba(8,127,53,0.08)]"
            : "border-[#e7e9e7] shadow-[0_4px_15px_rgba(0,0,0,0.045)]"
        }
      `}
      style={{
        borderColor: isOpen ? LIGHT_GREEN : undefined,
      }}
    >
      {/* ACTIVE GREEN BORDER */}
      ...
      >
        ...
        <span
          ...
          style={{
            borderColor: isOpen ? LIGHT_GREEN : undefined,
            backgroundColor: isOpen ? LIGHT_GREEN : undefined,
          }}
        >
          {isOpen ? "−" : "+"}
        </span>
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2.5">
        {/* ICON */}
        <div
          className=" flex h-[34px] w-[34px] shrink-0 items-center justify-center rounded-full text-[#087F35] sm:h-[38px] sm:w-[38px] xl:h-[42px] xl:w-[42px]"
          style={{
            backgroundColor: `${LIGHT_GREEN}15`,
          }}
        >
          <FaHeadset className=" text-[17px] sm:text-[19px] xl:text-[20px] " />
        </div>
        ...
        <div className="min-w-0">
          ...
          <button
            type="button"
            className=" mt-[2px] text-[8px] font-extrabold transition-colors sm:text-[9px] xl:text-[10px] "
            style={{
              color: LIGHT_GREEN,
            }}
            onMouseEnter={(e) => {
...
// MAIN COMPONENT
export default function GurugramFaqs() {
  ...
  return (
    ...
    >
      {/* BACKGROUND OVERLAY */}
      <div className=" pointer-events-none absolute inset-0 z-0 bg-white/[0.82] " />
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <FaQuestionCircle
                    className=" text-[10px] text-[#03C35E] sm:text-[12px] "
                  />
                </div>

                <span
                  className=" text-[7px] font-extrabold uppercase tracking-[0.04em] text-[#03C35E] sm:text-[8px] md:text-[9px] "
                >
                  Help & Support
                </span>
              </div>
              ...
              >
                ...
                <h3
                  className=" mt-1 text-[19px] font-extrabold leading-none text-[#188A31] sm:text-[21px] md:text-[23px] lg:text-[21px] xl:text-[24px] 2xl:text-[26px] "
                >
                  Frequently Asked
                </h3>
                <div
