...
// app/components/home/vehicleforeverygroupsize/MumbaiVehicleForEveryGroupSize.tsx
"use client";
    ...
    >
      <div className="relative flex h-[65px] w-full items-end justify-center sm:h-[85px] md:h-[105px]">
        ...
        >
          <Image
            src={displayImages[0]}
            alt="Previous vehicle gallery image in Mumbai"
            fill
        ...
        >
          <Image
            src={displayImages[1]}
            alt="Current vehicle gallery image in Mumbai"
            fill
            sizes="(max-width: 768px) 100vw, 50vw"
            className="object-cover"
          />
        ...
        >
          <Image
            src={displayImages[2]}
            alt="Next vehicle gallery image in Mumbai"
            fill
            sizes="(max-width: 768px) 100vw, 50vw"
            className="object-cover"
          />
...
// MAIN COMPONENT
export default function MumbaiVehicleForEveryGroupSize() {
  return (
