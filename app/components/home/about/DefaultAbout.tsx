          ...
          >
            ...
            >
              <p>
                ...
                company, offering{" "}
                <strong className="font-bold text-[#03C35E]">affordable</strong>{" "}
                and{" "}
                <strong className="font-bold text-[#03C35E]">reliable</strong>{" "}
                travel solutions for every journey.
              </p>

              <p>
                From outstation trips, tempo travellers, mini buses, luxury cars
                to wedding, corporate events, family vacations and pilgrimage
                tours — we make every ride{" "}
              ...
              <p>
                ...
                Faridabad, Noida, Ghaziabad, Mumbai, Pune and more — we are
                always near you to serve better.
              </p>

              <p>
                Our mission is simple: to deliver the best travel experience at
                the best price with{" "}
