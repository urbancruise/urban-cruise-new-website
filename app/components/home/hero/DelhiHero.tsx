...
//         "
//       >
//         {/* Background — fills the entire box, always */}
//         <img
//           src="/images/hero/herobg.webp"
//           alt="Premium car rental in Delhi"
//           className="absolute inset-0 w-full h-full object-cover object-center"
//         />
//         <div className="absolute inset-x-0 bottom-0 h-[42%] bg-gradient-to-t from-black/25 via-black/5 to-transparent" />
//         {/* TEXT */}
//         <div
//   className="
...
//       mb-1 xs:mb-1.5 sm:mb-2 md:mb-2.5
//     "
//           >
//             <span
//               className="
...
//           className="
//             absolute left-1/2 -translate-x-1/2 z-10
//             w-full flex items-center justify-center px-2 sm:px-4
//             top-[52%] xs:top-[51%] sm:top-[30%] md:top-[26%] lg:top-[36%] xl:top-[34%]
//           "
//         >
//           <img
...
//               max-w-[400px] xs:max-w-[400px] sm:max-w-[560px] md:max-w-[700px] lg:max-w-[820px] xl:max-w-[960px] 2xl:max-w-[1080px]
//               scale-[1.15] xs:scale-[1.15] sm:scale-[1.12] md:scale-[1.12] lg:scale-[1.1] xl:scale-[1.1] 2xl:scale-[1.08]"
//           />
//         </div>
//       </div>

//       {/* QUICK CALL FORM */}
//       <div className="relative z-20 -mt-16 xs:-mt-18 sm:-mt-10 md:-mt-12 lg:-mt-24 xl:-mt-18">
