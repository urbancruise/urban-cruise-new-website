// app/components/services/MumbaiCharDhamPage.tsx
"use client";
...
export default function MumbaiCharDhamPage() {
  ...
  const packages = [
    {
      ...
      duration: "10 Days",
      price: "₹36,000",
      features: ["Mumbai to Char Dham", "9 Nights Stay", "All Temple Visits", "Meals Included"]
    },
    {
      name: "Char Dham Premium",
      duration: "12 Days",
      price: "₹46,000",
      features: ["Mumbai to Char Dham", "11 Nights Stay", "All Temple Visits", "Luxury Stay"]
    },
    {
    ...
    },
    {
      ...
      duration: "11 Days",
      price: "₹56,000",
      features: ["Mumbai to Char Dham", "10 Nights Stay", "VIP Darshan", "Premium Service"]
    },
  ];
  ...
  const itinerary = [
    ...
    { day: "Day 10", title: "Return to Mumbai", desc: "Return journey with divine blessings." },
  ];
  ...
  const reviews = [
    {
      ...
      rating: 5,
      text: "A divine experience! The Char Dham Yatra from Mumbai was well-organized and comfortable.",
      date: "2 days ago"
    },
    {
    ...
    },
    {
      name: "Mr. Amit Shah",
      rating: 5,
      text: "Great service! The Char Dham Yatra package from Mumbai was perfect for our family pilgrimage.",
      date: "1 week ago"
    },
  ];
    ...
    <div className="min-h-screen bg-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-[#ff6b6b]/20 backdrop-blur-sm px-4 py-2 rounded-full mb-4 border border-[#ff6b6b]/30">
                ...
                <span className="text-[#ff6b6b] font-medium text-sm">Mumbai - Char Dham Yatra</span>
              </div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight mb-4">
                <span className="bg-gradient-to-r from-[#ff6b6b] to-[#feca57] bg-clip-text text-transparent">Char Dham Yatra</span><br />Package from Mumbai
              </h1>
              <p className="text-lg text-gray-300 mb-6">Embark on a divine journey to the sacred Char Dham (Yamunotri, Gangotri, Kedarnath, and Badrinath). Our comprehensive package ensures a comfortable and spiritual experience from Mumbai.</p>
            ...
            <div className="relative">
              <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-4 border border-white/10">
                <div className="relative h-[300px] md:h-[350px] rounded-xl overflow-hidden">
                  <Image src={vehicleImages[selectedImage]} alt="Vehicle for Char Dham pilgrimage travel from Mumbai" fill sizes="(max-width: 768px) 100vw, 50vw" className="object-cover" />
                </div>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-[#0c0c1e] mb-4">Char Dham Yatra from Mumbai</h2>
              <p className="text-gray-600 mb-4">Experience the divine journey to Yamunotri, Gangotri, Kedarnath, and Badrinath - the four most sacred pilgrimage sites in India. Our Char Dham Yatra package from Mumbai offers a perfect blend of spirituality and comfort.</p>
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <span className="px-3 py-1 bg-[#ff6b6b]/10 text-[#ff6b6b] text-sm rounded-full">Kedarnath</span>
                <span className="px-3 py-1 bg-[#ff6b6b]/10 text-[#ff6b6b] text-sm rounded-full">Badrinath</span>
              </div>
            </div>
            <div>
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-[#ff6b6b] to-[#ff9a9a]">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-white/90 text-lg max-w-2xl mx-auto mb-8">Book your Char Dham Yatra from Mumbai today and seek divine blessings.</p>
