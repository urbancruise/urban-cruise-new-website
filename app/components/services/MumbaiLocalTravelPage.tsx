// app/components/services/MumbaiLocalTravelPage.tsx
"use client";
...
export default function MumbaiLocalTravelPage() {
  ...
  const features = [
    ...
    { icon: FaCity, label: "Coverage", value: "Mumbai" },
  ...
  const services = [
    ...
    { name: "City Tours", desc: "Explore Mumbai" },
  ...
  const packages = [
    {
      ...
      duration: "Per Trip",
      price: "₹900+",
      features: ["Mumbai Airport", "Flexible Timing", "Professional Driver", "Comfortable Vehicle"]
    },
    {
      name: "City Tour",
      duration: "4-8 Hours",
      price: "₹2,800+",
      features: ["Mumbai Sightseeing", "Guide Available", "Flexible Itinerary", "AC Vehicle"]
    },
    {
      name: "Local Travel",
      duration: "Per Hour",
      price: "₹550+",
      features: ["Mumbai City", "Flexible Routes", "Hourly Booking", "Professional Service"]
    },
    {
      name: "Day Package",
      duration: "Full Day",
      price: "₹4,500+",
      features: ["Mumbai City", "Multiple Stops", "All Inclusive", "Premium Service"]
    },
  ];
  ...
  const reviews = [
    {
      ...
      rating: 5,
      text: "Excellent local travel service in Mumbai! The driver was punctual and the vehicle was very comfortable.",
      date: "2 days ago"
    },
    {
      name: "Ms. Priyanka (Team)",
      rating: 5,
      text: "Great service for local travel in Mumbai. Reliable and professional.",
      date: "5 days ago"
    },
    {
      name: "Mr. Amit Shah",
      rating: 4,
      text: "Good local travel service in Mumbai. The rates are reasonable and service is prompt.",
      date: "1 week ago"
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-[#ff6b6b]/20 backdrop-blur-sm px-4 py-2 rounded-full mb-4 border border-[#ff6b6b]/30">
                ...
                <span className="text-[#ff6b6b] font-medium text-sm">Mumbai - Local Travel</span>
              </div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight mb-4">
                <span className="bg-gradient-to-r from-[#ff6b6b] to-[#feca57] bg-clip-text text-transparent">Local</span><br />Bus & Car Rental
              </h1>
              <p className="text-lg text-gray-300 mb-6">Convenient and reliable local travel solutions in Mumbai. Airport transfers, city tours, sightseeing, and daily commuting services.</p>
            ...
            <div className="relative">
              <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-4 border border-white/10">
                <div className="relative h-[300px] md:h-[350px] rounded-xl overflow-hidden">
                  <Image src={vehicleImages[selectedImage]} alt="Local travel vehicle available in Mumbai" fill sizes="(max-width: 768px) 100vw, 50vw" className="object-cover" />
                </div>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-[#0c0c1e] mb-4">Local Travel Services</h2>
            <p className="text-gray-600 text-lg">Comprehensive local travel solutions in Mumbai.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {services.map((service, index) => (
              <div key={index} className="bg-white rounded-xl p-6 text-center shadow-sm hover:shadow-md transition-all duration-300">
                <div className="w-16 h-16 rounded-full bg-[#ff6b6b]/10 flex items-center justify-center text-[#ff6b6b] text-3xl mx-auto mb-4"><FaCity /></div>
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-[#0c0c1e] mb-4">Local Travel Service</h2>
              <p className="text-gray-600 mb-4">Reliable and convenient local travel solutions for Mumbai. We offer a range of services including airport transfers, city tours, and daily commuting.</p>
              <p className="text-gray-600 mb-6">Our vehicles are well-maintained and our drivers are experienced professionals who know Mumbai's roads and traffic patterns.</p>
              <div className="flex flex-wrap gap-3">
                <span className="px-3 py-1 bg-[#ff6b6b]/10 text-[#ff6b6b] text-sm rounded-full">Airport Transfer</span>
                <span className="px-3 py-1 bg-[#ff6b6b]/10 text-[#ff6b6b] text-sm rounded-full">City Tour</span>
                <span className="px-3 py-1 bg-[#ff6b6b]/10 text-[#ff6b6b] text-sm rounded-full">Daily Commute</span>
              </div>
            </div>
            <div>
              <h3 className="text-2xl font-bold text-[#0c0c1e] mb-4">Why Choose Us?</h3>
              <div className="space-y-4">
                <div className="flex items-start gap-3"><FaCheck className="text-[#ff6b6b] mt-1" /><div><h4 className="font-semibold text-[#0c0c1e]">24/7 Service</h4><p className="text-gray-600 text-sm">Available round the clock for your convenience.</p></div></div>
                <div className="flex items-start gap-3"><FaCheck className="text-[#ff6b6b] mt-1" /><div><h4 className="font-semibold text-[#0c0c1e]">Professional Drivers</h4><p className="text-gray-600 text-sm">Experienced drivers with local knowledge.</p></div></div>
                <div className="flex items-start gap-3"><FaCheck className="text-[#ff6b6b] mt-1" /><div><h4 className="font-semibold text-[#0c0c1e]">Flexible Booking</h4><p className="text-gray-600 text-sm">Hourly, daily, or trip-based options.</p></div></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="packages" className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-[#0c0c1e] mb-4">Local Travel Packages</h2>
            <p className="text-gray-600 text-lg">Choose from our local travel packages in Mumbai.</p>
          </div>
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600 text-lg">What our customers say about our local travel service in Mumbai.</p>
          </div>
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-[#ff6b6b] to-[#ff9a9a]">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-white/90 text-lg max-w-2xl mx-auto mb-8">Book your local travel vehicle in Mumbai today and experience convenience.</p>
