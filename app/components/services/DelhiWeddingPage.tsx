// app/components/services/DelhiWeddingPage.tsx
"use client";
...
export default function DelhiWeddingPage() {
  ...
  const reviews = [
    {
      name: "Mr. & Mrs. Sharma",
      rating: 5,
      text: "Our wedding was made perfect by Urban Cruise. The cars were stunning and the service was impeccable.",
      date: "2 days ago"
    },
    {
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-[#e94560]/20 backdrop-blur-sm px-4 py-2 rounded-full mb-4 border border-[#e94560]/30">
                ...
                <span className="text-[#e94560] font-medium text-sm">Delhi - Wedding Travel</span>
              </div>
              ...
              <p className="text-lg text-gray-300 mb-6">
                ...
                Luxury cars, convoy arrangements, and guest transport.
              </p>
            ...
            <div className="relative">
              <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-4 border border-white/10">
                <div className="relative h-[300px] md:h-[350px] rounded-xl overflow-hidden">
                  <Image src={vehicleImages[selectedImage]} alt="Wedding transport vehicle available in Delhi" fill sizes="(max-width: 768px) 100vw, 50vw" className="object-cover" />
                </div>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-[#1a1a2e] mb-4">Our Wedding Fleet</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {vehicles.map((vehicle, index) => (
              <div key={index} className="bg-white rounded-xl p-6 text-center shadow-sm hover:shadow-md transition-all duration-300">
                <div className="w-16 h-16 rounded-full bg-[#e94560]/10 flex items-center justify-center text-[#e94560] text-3xl mx-auto mb-4"><FaCar /></div>
                <h3 className="text-xl font-bold text-[#1a1a2e] mb-2">{vehicle.name}</h3>
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-[#1a1a2e] mb-4">Wedding Travel Service</h2>
              ...
              <div className="flex flex-wrap gap-3">
                <span className="px-3 py-1 bg-[#e94560]/10 text-[#e94560] text-sm rounded-full">Luxury Cars</span>
                <span className="px-3 py-1 bg-[#e94560]/10 text-[#e94560] text-sm rounded-full">Convoy Service</span>
                <span className="px-3 py-1 bg-[#e94560]/10 text-[#e94560] text-sm rounded-full">Guest Transport</span>
              </div>
            </div>
            <div>
              <h3 className="text-2xl font-bold text-[#1a1a2e] mb-4">Why Choose Us?</h3>
              <div className="space-y-4">
                <div className="flex items-start gap-3"><FaCheck className="text-[#e94560] mt-1" /><div><h4 className="font-semibold text-[#1a1a2e]">Premium Fleet</h4><p className="text-gray-600 text-sm">Luxury vehicles for your special day.</p></div></div>
                <div className="flex items-start gap-3"><FaCheck className="text-[#e94560] mt-1" /><div><h4 className="font-semibold text-[#1a1a2e]">Professional Chauffeurs</h4><p className="text-gray-600 text-sm">Experienced and dressed professionally.</p></div></div>
                <div className="flex items-start gap-3"><FaCheck className="text-[#e94560] mt-1" /><div><h4 className="font-semibold text-[#1a1a2e]">Full Coordination</h4><p className="text-gray-600 text-sm">Complete wedding travel management.</p></div></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="packages" className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-[#1a1a2e] mb-4">Wedding Packages</h2>
