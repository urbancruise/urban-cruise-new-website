// app/components/services/MumbaiVacationsPage.tsx
"use client";
...
export default function MumbaiVacationsPage() {
  ...
  const packages = [
    {
      ...
      duration: "2-3 Days",
      price: "₹9,000+",
      features: ["Mumbai to Destination", "Sightseeing", "Comfortable Vehicle", "Flexible Schedule"]
    },
    {
      name: "Week Vacation",
      duration: "7 Days",
  ...
  const reviews = [
    {
      ...
      rating: 5,
      text: "Amazing vacation experience! Urban Cruise Mumbai made our family trip comfortable and memorable.",
      date: "2 days ago"
    },
    {
      name: "Ms. Priyanka (Team)",
      rating: 5,
      text: "Perfect vacation package from Mumbai! The vehicle was comfortable and the driver was very helpful.",
      date: "5 days ago"
    },
    {
      name: "Mr. Amit Shah",
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-[#ff6b6b]/20 backdrop-blur-sm px-4 py-2 rounded-full mb-4 border border-[#ff6b6b]/30">
                ...
                <span className="text-[#ff6b6b] font-medium text-sm">Mumbai - Vacations</span>
              </div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight mb-4">
                <span className="bg-gradient-to-r from-[#ff6b6b] to-[#feca57] bg-clip-text text-transparent">Vacation</span><br />Bus Rentals
              </h1>
              <p className="text-lg text-gray-300 mb-6">Plan your perfect vacation from Mumbai with our bus rental service. Explore India's beautiful destinations with comfort and style.</p>
            ...
            <div className="relative">
              <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-4 border border-white/10">
                <div className="relative h-[300px] md:h-[350px] rounded-xl overflow-hidden">
                  <Image src={vehicleImages[selectedImage]} alt="Vacation travel vehicle available from Mumbai" fill sizes="(max-width: 768px) 100vw, 50vw" className="object-cover" />
                </div>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-[#0c0c1e] mb-4">Popular Vacation Destinations</h2>
            <p className="text-gray-600 text-lg">Explore India's most beautiful vacation spots from Mumbai.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {destinations.map((dest, index) => (
              <div key={index} className="bg-white rounded-xl p-6 text-center shadow-sm hover:shadow-md transition-all duration-300">
                <div className="w-16 h-16 rounded-full bg-[#ff6b6b]/10 flex items-center justify-center text-[#ff6b6b] text-3xl mx-auto mb-4"><FaUmbrella /></div>
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-[#0c0c1e] mb-4">Vacation Travel Service</h2>
              <p className="text-gray-600 mb-4">Make your vacation unforgettable with our comfortable and reliable bus rental service from Mumbai. We offer flexible packages for family trips, group tours, and solo adventures.</p>
              ...
              <div className="flex flex-wrap gap-3">
                <span className="px-3 py-1 bg-[#ff6b6b]/10 text-[#ff6b6b] text-sm rounded-full">Family Trips</span>
                <span className="px-3 py-1 bg-[#ff6b6b]/10 text-[#ff6b6b] text-sm rounded-full">Group Tours</span>
                <span className="px-3 py-1 bg-[#ff6b6b]/10 text-[#ff6b6b] text-sm rounded-full">Adventure</span>
              </div>
            </div>
            <div>
              <h3 className="text-2xl font-bold text-[#0c0c1e] mb-4">Why Choose Us?</h3>
              <div className="space-y-4">
                <div className="flex items-start gap-3"><FaCheck className="text-[#ff6b6b] mt-1" /><div><h4 className="font-semibold text-[#0c0c1e]">Flexible Packages</h4><p className="text-gray-600 text-sm">Customizable vacation itineraries.</p></div></div>
                <div className="flex items-start gap-3"><FaCheck className="text-[#ff6b6b] mt-1" /><div><h4 className="font-semibold text-[#0c0c1e]">Comfortable Travel</h4><p className="text-gray-600 text-sm">Well-maintained vehicles for your journey.</p></div></div>
                <div className="flex items-start gap-3"><FaCheck className="text-[#ff6b6b] mt-1" /><div><h4 className="font-semibold text-[#0c0c1e]">Expert Drivers</h4><p className="text-gray-600 text-sm">Professional drivers with destination knowledge.</p></div></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="packages" className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-[#0c0c1e] mb-4">Vacation Packages</h2>
            <p className="text-gray-600 text-lg">Choose from our vacation packages from Mumbai.</p>
          </div>
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600 text-lg">What our customers say about our vacation service from Mumbai.</p>
          </div>
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-[#ff6b6b] to-[#ff9a9a]">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-white/90 text-lg max-w-2xl mx-auto mb-8">Book your vacation vehicle from Mumbai today and start your journey.</p>
