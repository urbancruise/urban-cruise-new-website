// app/components/services/GurugramDoDhamPage.tsx
"use client";
...
export default function GurugramDoDhamPage() {
  ...
  const packages = [
    {
      ...
      duration: "7 Days",
      price: "₹25,000",
      features: ["Gurugram to Do Dham", "6 Nights Stay", "Temple Visits", "Meals Included"]
    },
    {
      name: "Do Dham Premium",
      duration: "9 Days",
      price: "₹35,000",
      features: ["Gurugram to Do Dham", "8 Nights Stay", "All Temple Visits", "Luxury Stay"]
    },
    {
      name: "Do Dham Group",
      duration: "7 Days",
    ...
    },
    {
      ...
      duration: "8 Days",
      price: "₹45,000",
      features: ["Gurugram to Do Dham", "7 Nights Stay", "VIP Darshan", "Premium Service"]
    },
  ];

  const itinerary = [
    { day: "Day 1", title: "Departure from Gurugram", desc: "Start your spiritual journey from Gurugram to Yamunotri." },
    ...
    { day: "Day 7", title: "Return to Gurugram", desc: "Return journey with divine blessings." },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-[#6c5ce7]/20 backdrop-blur-sm px-4 py-2 rounded-full mb-4 border border-[#6c5ce7]/30">
                ...
                <span className="text-[#a29bfe] font-medium text-sm">Gurugram - Do Dham Yatra</span>
              </div>
            ...
            <div className="relative">
              <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-4 border border-white/10">
                <div className="relative h-[300px] md:h-[350px] rounded-xl overflow-hidden">
                  <Image src={vehicleImages[selectedImage]} alt="Vehicle for Do Dham pilgrimage travel from Gurugram" fill sizes="(max-width: 768px) 100vw, 50vw" className="object-cover" />
                </div>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-[#0c0c1d] mb-4">Do Dham Yatra from Gurugram</h2>
              <p className="text-gray-600 mb-4">Experience the divine journey to Yamunotri and Gangotri, two of the most sacred pilgrimage sites in India. Our Do Dham Yatra package from Gurugram offers a perfect blend of spirituality and comfort.</p>
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <span className="px-3 py-1 bg-[#6c5ce7]/10 text-[#6c5ce7] text-sm rounded-full">Spiritual Tour</span>
                <span className="px-3 py-1 bg-[#6c5ce7]/10 text-[#6c5ce7] text-sm rounded-full">Pilgrimage</span>
              </div>
            </div>
            <div>
