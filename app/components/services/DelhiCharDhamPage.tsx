// app/components/services/DelhiCharDhamPage.tsx
"use client";
...
export default function DelhiCharDhamPage() {
  ...
  const packages = [
    {
      ...
      duration: "10 Days",
      price: "₹35,000",
      features: ["Delhi to Char Dham", "9 Nights Stay", "All Temple Visits", "Meals Included"]
    },
    {
      name: "Char Dham Premium",
      duration: "12 Days",
      price: "₹45,000",
      features: ["Delhi to Char Dham", "11 Nights Stay", "All Temple Visits", "Luxury Stay"]
    },
    {
    ...
    },
    {
      ...
      duration: "11 Days",
      price: "₹55,000",
      features: ["Delhi to Char Dham", "10 Nights Stay", "VIP Darshan", "Premium Service"]
    },
  ];
  ...
  const itinerary = [
    ...
    { day: "Day 10", title: "Return to Delhi", desc: "Return journey with divine blessings." },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-[#e94560]/20 backdrop-blur-sm px-4 py-2 rounded-full mb-4 border border-[#e94560]/30">
                ...
                <span className="text-[#e94560] font-medium text-sm">Delhi - Char Dham Yatra</span>
              </div>
              ...
              <p className="text-lg text-gray-300 mb-6">
                Embark on a divine journey to the sacred Char Dham (Yamunotri, Gangotri, Kedarnath, and Badrinath). 
                Our comprehensive package ensures a comfortable and spiritual experience.
              </p>
            ...
            <div className="relative">
              <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-4 border border-white/10">
                <div className="relative h-[300px] md:h-[350px] rounded-xl overflow-hidden">
                  <Image src={vehicleImages[selectedImage]} alt="Vehicle for Char Dham pilgrimage travel from Delhi" fill sizes="(max-width: 768px) 100vw, 50vw" className="object-cover" />
                </div>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-[#1a1a2e] mb-4">Char Dham Yatra from Delhi</h2>
              <p className="text-gray-600 mb-4">Experience the divine journey to Yamunotri, Gangotri, Kedarnath, and Badrinath - the four most sacred pilgrimage sites in India. Our Char Dham Yatra package from Delhi offers a perfect blend of spirituality and comfort.</p>
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <span className="px-3 py-1 bg-[#e94560]/10 text-[#e94560] text-sm rounded-full">Kedarnath</span>
                <span className="px-3 py-1 bg-[#e94560]/10 text-[#e94560] text-sm rounded-full">Badrinath</span>
              </div>
            </div>
            <div>
