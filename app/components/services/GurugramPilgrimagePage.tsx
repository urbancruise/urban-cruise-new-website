            ...
            <div className="relative">
              <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-4 border border-white/10">
                <div className="relative h-[300px] md:h-[350px] rounded-xl overflow-hidden">
                  <Image src={vehicleImages[selectedImage]} alt="Pilgrimage travel vehicle available in Gurugram" fill sizes="(max-width: 768px) 100vw, 50vw" className="object-cover" />
                </div>
