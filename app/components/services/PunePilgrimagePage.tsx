// app/components/services/PunePilgrimagePage.tsx
"use client";
...
export default function PunePilgrimagePage() {
  ...
  const packages = [
    {
      ...
      duration: "3 Days",
      price: "₹8,000",
      features: ["Pune to Pilgrimage Site", "2 Nights Stay", "Temple Visits", "Meals Included"]
    },
    {
      name: "Premium Pilgrimage",
      duration: "5 Days",
      price: "₹15,000",
      features: ["Pune to Pilgrimage Site", "4 Nights Stay", "All Temple Visits", "Luxury Stay"]
    },
    {
      name: "Group Pilgrimage",
      duration: "4 Days",
      price: "₹10,000",
      features: ["Pune to Pilgrimage Site", "3 Nights Stay", "Group Discount", "Meals Included"]
    },
    {
  ...
  const reviews = [
    {
      name: "Dr. Meera Joshi",
      rating: 5,
      text: "Excellent pilgrimage tour from Pune! The service was top-notch and the driver was very knowledgeable.",
      date: "2 days ago"
    },
    {
    ...
    },
    {
      ...
      rating: 4,
      text: "Great service! The pilgrimage package from Pune was well-organized and reasonably priced.",
      date: "1 week ago"
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-[#00b894]/20 backdrop-blur-sm px-4 py-2 rounded-full mb-4 border border-[#00b894]/30">
                ...
                <span className="text-[#55efc4] font-medium text-sm">Pune - Pilgrimage Travel</span>
              </div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight mb-4">
                <span className="bg-gradient-to-r from-[#00b894] to-[#55efc4] bg-clip-text text-transparent">Pilgrimage</span><br />Vehicle Rental
              </h1>
              <p className="text-lg text-gray-300 mb-6">Embark on a spiritual journey with our pilgrimage vehicle rental service from Pune. Comfortable transportation to sacred destinations across India.</p>
            ...
            <div className="relative">
              <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-4 border border-white/10">
                <div className="relative h-[300px] md:h-[350px] rounded-xl overflow-hidden">
                  <Image src={vehicleImages[selectedImage]} alt="Pilgrimage travel vehicle available in Pune" fill sizes="(max-width: 768px) 100vw, 50vw" className="object-cover" />
                </div>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-[#0a1a0a] mb-4">Popular Pilgrimage Destinations</h2>
            <p className="text-gray-600 text-lg">Explore the most sacred destinations with our pilgrimage travel service from Pune.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {destinations.map((dest, index) => (
              <div key={index} className="bg-white rounded-xl p-6 text-center shadow-sm hover:shadow-md transition-all duration-300">
                <div className="w-16 h-16 rounded-full bg-[#00b894]/10 flex items-center justify-center text-[#00b894] text-3xl mx-auto mb-4"><FaTelegramPlane /></div>
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-[#0a1a0a] mb-4">Pilgrimage Travel Service</h2>
              <p className="text-gray-600 mb-4">Our pilgrimage vehicle rental service from Pune offers comfortable and reliable transportation to sacred destinations. We understand the importance of spiritual journeys and ensure a hassle-free experience.</p>
              ...
              <div className="flex flex-wrap gap-3">
                <span className="px-3 py-1 bg-[#00b894]/10 text-[#00b894] text-sm rounded-full">Char Dham</span>
                <span className="px-3 py-1 bg-[#00b894]/10 text-[#00b894] text-sm rounded-full">Spiritual Tours</span>
                <span className="px-3 py-1 bg-[#00b894]/10 text-[#00b894] text-sm rounded-full">Temple Visits</span>
              </div>
            </div>
            <div>
              <h3 className="text-2xl font-bold text-[#0a1a0a] mb-4">Why Choose Us?</h3>
              <div className="space-y-4">
                <div className="flex items-start gap-3"><FaCheck className="text-[#00b894] mt-1" /><div><h4 className="font-semibold text-[#0a1a0a]">Spiritual Experience</h4><p className="text-gray-600 text-sm">Journey with comfort and devotion.</p></div></div>
                <div className="flex items-start gap-3"><FaCheck className="text-[#00b894] mt-1" /><div><h4 className="font-semibold text-[#0a1a0a]">Experienced Drivers</h4><p className="text-gray-600 text-sm">Safe and reliable transportation.</p></div></div>
                <div className="flex items-start gap-3"><FaCheck className="text-[#00b894] mt-1" /><div><h4 className="font-semibold text-[#0a1a0a]">Flexible Itinerary</h4><p className="text-gray-600 text-sm">Customize your pilgrimage tour.</p></div></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="packages" className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-[#0a1a0a] mb-4">Pilgrimage Packages</h2>
            <p className="text-gray-600 text-lg">Choose from our flexible pilgrimage packages from Pune.</p>
          </div>
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-gray-600 text-lg">What our customers say about our pilgrimage service from Pune.</p>
          </div>
      ...
      <section className="py-16 md:py-20 bg-gradient-to-r from-[#00b894] to-[#55efc4]">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-white/90 text-lg max-w-2xl mx-auto mb-8">Book your pilgrimage vehicle rental from Pune today and experience divine travel.</p>
